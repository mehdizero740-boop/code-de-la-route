...
export const QUESTIONS = [
  ...
  ], "Tout conducteur doit faciliter le passage des véhicules d'intérêt général prioritaires en mission urgente, en s'écartant prudemment et sans précipitation dangereuse.", { image: "https://images.unsplash.com/photo-1691435702806-17d0aa7b02e9?auto=format&fit=crop&w=800&q=70" }),
  ...
  ], "Ces distances minimales de dépassement des cyclistes et piétons sont fixées par le code de la route depuis 2017.", { image: "https://images.unsplash.com/photo-1775127458582-7a601385d361?auto=format&fit=crop&w=800&q=70" }),
  ...
  ], "En dessous de 1,6 mm, le pneu est hors normes légales et l'adhérence, notamment sur sol mouillé, est fortement dégradée.", { image: "https://images.unsplash.com/photo-1685270387102-5c0fccf96ad9?auto=format&fit=crop&w=800&q=70" }),
  ...
  ], "Un stationnement gênant, même bref, peut être verbalisé s'il perturbe la circulation, l'accès ou la visibilité.", { image: "https://images.unsplash.com/photo-1749840705747-21cc842efab8?auto=format&fit=crop&w=800&q=70" }),
 ...
 // Le conducteur
  ...
  ], "Les angles morts des poids lourds sont une cause fréquente d'accidents impliquant piétons et cyclistes, notamment aux intersections.", { image: "https://images.unsplash.com/photo-1720811559395-3ed8d1b16649?auto=format&fit=crop&w=800&q=70" }),
  ...
  ], "Les radars appliquent une marge d'erreur technique réglementaire déduite de la vitesse mesurée avant sanction.", { image: "https://images.unsplash.com/photo-1782753280065-f73603cc400c?auto=format&fit=crop&w=800&q=70" }),
...
/* ===== VAGUE 28 — loi Badinter, indemnisation des victimes ===== */
  ...
  // ============================================================
  // QUESTIONS DIFFICILES (ajout) - articles precis, montants exacts,
  // nuances juridiques et reformes 2024-2026
  // ============================================================
  q("signalisation", "Vous franchissez un feu rouge fixe sans vous en rendre compte, par inattention. Sur le plan légal :", [
    { text: "La sanction est identique à un franchissement volontaire : 135 € et 4 points (article R412-30)", correct: true },
    { text: "L'absence d'intention réduit l'amende à une contravention de 2e classe", correct: false },
    { text: "Seul un retrait de points est appliqué, sans amende, en cas de bonne foi", correct: false },
    { text: "L'infraction n'est pas constituée car il n'y a pas eu de volonté de griller le feu", correct: false },
  ], "L'article R412-30 sanctionne le simple fait de franchir la ligne d'effet des feux alors que le feu est rouge, indépendamment de l'intention : 135 € d'amende et 4 points, quelles que soient les circonstances.", { difficulty: "difficile" }),
  q("signalisation", "Un panneau STOP et un feu rouge grillé sont-ils sanctionnés de la même façon ?", [
    { text: "Oui : dans les deux cas, 135 € et 4 points (articles R415-6 et R412-30)", correct: true },
    { text: "Non, le stop est moins sanctionné car il n'y a pas de dispositif électronique", correct: false },
    { text: "Non, le stop entraîne 2 points de moins que le feu rouge", correct: false },
    { text: "Non, le feu rouge entraîne une amende supérieure au stop", correct: false },
  ], "Beaucoup de conducteurs pensent le stop moins grave qu'un feu rouge. En réalité, les deux infractions sont des contraventions de 4e classe identiques : 135 € et 4 points.", { difficulty: "difficile" }),
  q("signalisation", "Vous arrivez à un feu orange fixe et pouvez encore vous arrêter en toute sécurité, mais vous décidez de passer. Que risquez-vous ?", [
    { text: "35 € d'amende, sans retrait de points", correct: true },
    { text: "135 € d'amende et 4 points, comme pour un feu rouge", correct: false },
    { text: "Aucune sanction, le feu orange n'est qu'un avertissement", correct: false },
    { text: "135 € d'amende mais sans retrait de points", correct: false },
  ], "L'article R412-31 impose l'arrêt au feu orange fixe sauf impossibilité de s'arrêter en sécurité. Le non-respect est sanctionné, mais bien moins lourdement que le feu rouge : 35 € sans perte de points, contrairement au feu rouge (135 €, 4 points).", { difficulty: "difficile" }),
  q("signalisation", "Un feu tricolore est en panne et clignote orange dans les quatre directions. Comment la priorité s'établit-elle à ce carrefour ?", [
    { text: "Par la signalisation verticale de priorité (panneaux stop, cédez le passage) ou, à défaut, la priorité à droite", correct: true },
    { text: "Le premier arrivé au carrefour est prioritaire, comme un stop généralisé", correct: false },
    { text: "Le feu orange clignotant impose l'arrêt absolu à tous les véhicules, comme un feu rouge", correct: false },
    { text: "La priorité revient automatiquement au véhicule le plus à gauche", correct: false },
  ], "Un feu orange clignotant signale un dysfonctionnement : il invite à la prudence mais ne remplace pas une règle de priorité. C'est alors la signalisation verticale, ou à défaut la priorité à droite, qui s'applique.", { difficulty: "difficile" }),
  q("signalisation", "Depuis le décret n° 2015-808 du 2 juillet 2015, un conducteur qui franchit une ligne blanche continue pour dépasser un cycliste :", [
    { text: "Ne commet pas d'infraction s'il respecte les distances de sécurité et que la visibilité le permet", correct: true },
    { text: "Commet toujours une infraction, la ligne continue restant infranchissable quel que soit l'usager dépassé", correct: false },
    { text: "Doit obligatoirement s'arrêter derrière le cycliste jusqu'à la fin de la ligne continue", correct: false },
    { text: "Peut franchir la ligne uniquement de nuit", correct: false },
  ], "Ce décret a créé une exception à l'article R412-19 : franchir une ligne continue pour dépasser un cycliste ou un cyclomoteur est autorisé si la manœuvre est sûre, précisément pour permettre le respect de la distance latérale imposée par l'article R414-4.", { difficulty: "difficile" }),
  q("signalisation", "Un panneau STOP est planté à un carrefour, mais aucune ligne d'effet n'est peinte au sol. Où le conducteur doit-il marquer l'arrêt ?", [
    { text: "Avant le passage piéton qui précède le panneau ou, à défaut, à l'aplomb du panneau lui-même", correct: true },
    { text: "N'importe où avant d'entrer dans le carrefour, la position exacte étant sans importance", correct: false },
    { text: "L'infraction ne peut pas être constatée en l'absence de marquage au sol", correct: false },
    { text: "Le conducteur doit s'arrêter au minimum 5 mètres avant le panneau", correct: false },
  ], "En l'absence de ligne d'arrêt matérialisée, la règle de référence est l'arrêt avant le passage piéton qui précède le feu ou le panneau, ou à défaut à l'aplomb de celui-ci — l'absence de marquage ne supprime pas l'obligation d'arrêt.", { difficulty: "difficile" }),
  q("signalisation", "Pour circuler dans une zone à faibles émissions (ZFE) sans la vignette Crit'Air requise, un conducteur de voiture particulière risque :", [
    { text: "Une amende forfaitaire de 68 €", correct: true },
    { text: "Une amende forfaitaire de 135 € identique quel que soit le véhicule", correct: false },
    { text: "Un retrait de 3 points sur son permis", correct: false },
    { text: "La confiscation immédiate du véhicule", correct: false },
  ], "Le défaut de vignette Crit'Air conforme en ZFE est sanctionné par une amende de 68 € pour les véhicules légers (135 € pour les poids lourds), sans retrait de points sur le permis.", { difficulty: "difficile" }),
  q("signalisation", "En mai 2026, une loi supprimant les zones à faibles émissions avait été votée par le Parlement. Quelle est la situation réelle des ZFE depuis cette date ?", [
    { text: "Le Conseil constitutionnel a censuré cette suppression le 21 mai 2026 : les ZFE et la vignette Crit'Air restent en vigueur", correct: true },
    { text: "Les ZFE ont bien été supprimées sur tout le territoire depuis le 21 mai 2026", correct: false },
    { text: "Seules les ZFE de Paris et Lyon ont été maintenues, les autres ont disparu", correct: false },
    { text: "La suppression est entrée en vigueur mais seulement pour les deux-roues", correct: false },
  ], "La suppression des ZFE, ajoutée par amendement à une loi de simplification économique, a été jugée sans lien suffisant avec le texte (cavalier législatif) et censurée par le Conseil constitutionnel : les ZFE restent donc actives.", { difficulty: "difficile" }),
  q("signalisation", "Un radar automatique de feu rouge déclenche une verbalisation. À quel moment précis l'infraction est-elle considérée comme constituée ?", [
    { text: "Dès que l'avant du véhicule franchit la ligne d'effet des feux (LEF) alors que le rouge est allumé depuis au moins 0,1 seconde", correct: true },
    { text: "Uniquement si le véhicule traverse entièrement le carrefour au rouge", correct: false },
    { text: "Dès que le feu passe au rouge, quel que soit l'endroit où se trouve le véhicule", correct: false },
    { text: "Seulement si un autre usager a dû freiner pour éviter une collision", correct: false },
  ], "Le radar prend deux photos : la première dès que l'avant du véhicule dépasse la ligne d'effet des feux (LEF) alors que le rouge est déjà allumé depuis au moins 0,1 seconde, la seconde confirmant le franchissement.", { difficulty: "difficile" }),
  q("signalisation", "Un panonceau placé sous un panneau « cédez le passage » indique une distance chiffrée. À quoi correspond-elle ?", [
    { text: "À l'emplacement de l'intersection concernée, situthey en aval du panneau", correct: false },
    { text: "À l'emplacement de l'intersection concernée par rapport au panneau", correct: true },
    { text: "À la distance minimale de sécurité à respecter avec le véhicule prioritaire", correct: false },
    { text: "À la distance sur laquelle le panneau reste valable avant d'être renouvelé", correct: false },
  ], "Ce panonceau complémentaire précise à quelle distance se situe l'intersection annoncée, afin que le conducteur anticipe correctement l'endroit où s'applique l'obligation de céder le passage.", { difficulty: "difficile" }),
  q("signalisation", "Sur un panneau lumineux d'entrée de ZFE, un conducteur de camping-car classé Crit'Air 3 constate qu'il est interdit à la circulation. Peut-il tout de même y circuler ponctuellement ?", [
    { text: "Oui, s'il dispose d'un Pass ZFE journalier utilisé dans la limite du nombre de jours annuel autorisé", correct: true },
    { text: "Non, aucune dérogation n'existe jamais pour les véhicules Crit'Air 3", correct: false },
    { text: "Oui, automatiquement et sans limite, car les camping-cars sont exemptés de ZFE", correct: false },
    { text: "Non, seuls les véhicules Crit'Air 0 et 1 peuvent bénéficier d'un pass dérogatoire", correct: false },
  ], "Certaines métropoles (dont le Grand Paris) proposent un « Pass ZFE » permettant de circuler un nombre de jours limité par an malgré une vignette Crit'Air normalement interdite dans la zone.", { difficulty: "difficile" }),
  q("signalisation", "Un motard souhaite dépasser une file de voitures à l'arrêt en circulant entre les files (interfiling). Le panneau ou marquage qui autorise formellement cette pratique en France est :", [
    { text: "Aucun : l'interfiling n'est encadré par aucun panneau et reste une simple tolérance sans cadre légal généralisé", correct: true },
    { text: "Un panneau spécifique « circulation inter-files autorisée » présent sur toutes les autoroutes", correct: false },
    { text: "Le marquage au sol d'une bande cyclable, que les motards peuvent emprunter librement", correct: false },
    { text: "Le panonceau « M4y » qui généralise la pratique depuis 2021", correct: false },
  ], "Contrairement à une idée reçue, l'expérimentation de la circulation inter-files n'a jamais été généralisée par un texte pérenne et n'est identifiée par aucun panneau standard : elle reste juridiquement fragile.", { difficulty: "difficile" }),
  q("signalisation", "Un panneau de limitation de vitesse à 30 km/h est implanté en zone urbaine. Un panneau plus loin indique 50 km/h sans panneau de fin de zone 30 explicite entre les deux. Quelle vitesse s'applique après ce second panneau ?", [
    { text: "50 km/h : un nouveau panneau de prescription remplace la limitation précédente dès son implantation", correct: true },
    { text: "30 km/h continue de s'appliquer tant qu'un panneau de fin de zone n'a pas été vu", correct: false },
    { text: "Aucune limite ne s'applique tant que la cohérence entre les deux panneaux n'est pas clarifiée", correct: false },
    { text: "40 km/h, valeur intermédiaire par défaut", correct: false },
  ], "Un panneau de prescription de vitesse (rond à fond blanc, bordure rouge) s'applique immédiatement à son emplacement et remplace la prescription antérieure, sans qu'un panneau de fin de zone soit nécessaire.", { difficulty: "difficile" }),
  q("signalisation", "Sur autoroute, un panneau à messages variables affiche « 110 » alors que le panneau fixe indique 130. Quelle vitesse le conducteur doit-il respecter ?", [
    { text: "110 km/h : le message variable, activé en fonction des conditions de circulation ou météo, prime sur le panneau fixe", correct: true },
    { text: "130 km/h : seul le panneau fixe a une valeur réglementaire contraignante", correct: false },
    { text: "Le conducteur peut choisir la vitesse qu'il estime la plus sûre entre les deux valeurs", correct: false },
    { text: "120 km/h, moyenne entre les deux valeurs affichées", correct: false },
  ], "Les panneaux à messages variables ont la même valeur réglementaire que les panneaux fixes et priment sur eux lorsqu'ils sont activés, généralement en raison du trafic, de la météo ou de travaux.", { difficulty: "difficile" }),
  q("signalisation", "Un « sas vélo » est matérialisé au sol devant la ligne d'arrêt d'un feu tricolore. Un automobiliste qui s'arrête à l'intérieur de ce sas :", [
    { text: "Commet une infraction, ce sas devant rester exclusivement réservé aux cycles à l'arrêt", correct: true },
    { text: "Ne commet aucune infraction tant que le feu est rouge", correct: false },
    { text: "Peut y stationner uniquement pour tourner à gauche", correct: false },
    { text: "N'est en infraction que si un cycliste est physiquement présent dans le sas à cet instant", correct: false },
  ], "Le sas vélo est une zone d'avancement réservée aux cycles avant la ligne d'arrêt des véhicules à moteur ; s'y arrêter constitue un franchissement anticipé de la ligne d'effet des feux, sanctionné comme tel.", { difficulty: "difficile" }),
  q("signalisation", "Un panneau « cédez le passage » (triangle pointe en bas) impose-t-il un arrêt obligatoire comme un STOP ?", [
    { text: "Non : il impose de céder le passage et de ralentir, mais l'arrêt n'est obligatoire que si la circulation l'exige", correct: true },
    { text: "Oui, l'arrêt total est obligatoire dans tous les cas, exactement comme au STOP", correct: false },
    { text: "Non, il n'impose aucune obligation particulière si la route abordée est peu fréquentée", correct: false },
    { text: "Oui, mais uniquement en agglomération", correct: false },
  ], "Contrairement au STOP qui impose un arrêt total systématique, le « cédez le passage » n'oblige à s'arrêter que si un usager prioritaire arrive effectivement — sinon un simple ralentissement suffit.", { difficulty: "difficile" }),
  q("signalisation", "Un feu tricolore équipé d'un panonceau « tourne-à-droite » (flèche jaune) autorise un conducteur à tourner à droite alors que le feu est rouge, à condition de :", [
    { text: "Céder le passage à tous les usagers prioritaires, notamment piétons et cyclistes engagés", correct: true },
    { text: "S'arrêter obligatoirement avant de tourner, même si la voie est totalement libre", correct: false },
    { text: "Ne l'utiliser qu'en dehors des heures de pointe", correct: false },
    { text: "Attendre le passage au vert avant de tourner, le panonceau n'étant qu'indicatif", correct: false },
  ], "Ce dispositif, expérimenté puis généralisé dans plusieurs villes, autorise le tourne-à-droite au feu rouge à condition de marquer un temps d'observation et de céder le passage aux usagers prioritaires, notamment les piétons engagés.", { difficulty: "difficile" }),
  q("priorites", "Un conducteur refuse la priorité à un véhicule arrivant par la droite à une intersection non protégée par un panneau. Quelle sanction encourt-il ?", [
    { text: "135 € d'amende et 4 points, comme pour un refus de priorité classique", correct: true },
    { text: "35 € d'amende sans retrait de points", correct: false },
    { text: "135 € d'amende sans retrait de points", correct: false },
    { text: "Aucune sanction si aucun accident ne survient", correct: false },
  ], "Le refus de priorité, qu'il s'agisse d'un panneau « cédez le passage », d'un stop ou de la priorité à droite par défaut, est une contravention de 4e classe : 135 € d'amende et 4 points retirés (articles R415-5 et R415-7).", { difficulty: "difficile" }),
  q("priorites", "Lorsqu'un cycliste circule en groupe sur la chaussée, un automobiliste souhaitant les dépasser doit :", [
    { text: "Dépasser l'ensemble du groupe comme une seule unité, sans s'insérer entre les cyclistes", correct: true },
    { text: "Pouvoir se rabattre entre deux cyclistes du groupe dès qu'un espace suffisant apparaît", correct: false },
    { text: "Klaxonner avant chaque dépassement d'un groupe de cyclistes pour signaler sa présence", correct: false },
    { text: "Attendre que le groupe se scinde avant d'entamer tout dépassement", correct: false },
  ], "Un groupe de cyclistes doit être considéré et dépassé comme une seule entité : s'insérer entre deux cyclistes du même groupe pendant la manœuvre est dangereux et constitue un dépassement mal exécuté.", { difficulty: "difficile" }),
  q("priorites", "Sur une route prioritaire signalée par un panneau losange jaune, la priorité de ce conducteur cesse :", [
    { text: "Uniquement à la vue du panneau « fin de route prioritaire » ou losange barré", correct: true },
    { text: "Dès qu'il traverse la première intersection suivante", correct: false },
    { text: "Automatiquement à la sortie de l'agglomération suivante", correct: false },
    { text: "Dès qu'un panneau de limitation de vitesse apparaît sur cette route", correct: false },
  ], "La priorité conférée par le panneau « route à caractère prioritaire » demeure valable jusqu'à ce qu'un panneau explicite de fin de priorité (losange jaune barré) l'annule, quelles que soient les intersections traversées entretemps.", { difficulty: "difficile" }),
  q("priorites", "Dans un rond-point non muni de panneaux « cédez le passage » à l'entrée, quelle règle de priorité s'applique par défaut ?", [
    { text: "Les véhicules à l'entrée sont prioritaires sur ceux déjà engagés dans l'anneau (priorité à droite)", correct: true },
    { text: "Les véhicules déjà engagés dans l'anneau sont toujours prioritaires, comme dans les ronds-points modernes classiques", correct: false },
    { text: "Aucune règle ne s'applique : chacun s'engage à son tour", correct: false },
    { text: "La priorité revient au véhicule le plus lourd", correct: false },
  ], "En l'absence de panonceau « cédez le passage » à l'entrée (cas rare mais existant sur certains giratoires anciens), c'est la règle générale de la priorité à droite qui s'applique, inversant la logique habituelle des ronds-points modernes.", { difficulty: "difficile" }),
  q("priorites", "Un véhicule d'intérêt général prioritaire (pompiers, SAMU) circule tous feux et avertisseurs sonores enclenchés. Un automobiliste qui refuse de lui céder le passage à une intersection risque :", [
    { text: "135 € d'amende et 4 points, comme tout refus de priorité, avec un risque accru de poursuites en cas d'accident", correct: true },
    { text: "Aucune sanction spécifique tant qu'aucun contact physique n'a eu lieu", correct: false },
    { text: "Uniquement un rappel à l'ordre verbal sans conséquence sur le permis", correct: false },
    { text: "Une amende de 35 € car il s'agit d'une priorité différente de la priorité à droite classique", correct: false },
  ], "Le refus de priorité à un véhicule d'intérêt général prioritaire relève du même régime que tout refus de priorité (135 €, 4 points), avec un risque de qualification pénale plus lourde en cas d'accident provoqué.", { difficulty: "difficile" }),
  q("priorites", "À une intersection en T, la route que vous suivez se termine dans une route transversale non prioritaire. Qui est prioritaire par défaut, en l'absence de tout panneau ?", [
    { text: "Les véhicules circulant sur la route transversale, en vertu de la priorité à droite ou à gauche selon le sens", correct: true },
    { text: "Le véhicule arrivant en bout de la route qui se termine, car il roule tout droit", correct: false },
    { text: "Le véhicule le plus rapide au moment de l'approche", correct: false },
    { text: "Aucune règle ne s'applique dans une intersection en T", correct: false },
  ], "En l'absence de signalisation, la règle de la priorité à droite (ou à gauche selon la configuration) continue de s'appliquer même dans une intersection en T : le fait que la route se termine ne crée pas automatiquement une priorité.", { difficulty: "difficile" }),
  q("priorites", "Un conducteur s'engage sur un rond-point alors qu'un panneau « cédez le passage » est placé à l'entrée. Un véhicule est déjà engagé dans l'anneau au moment où il s'engage. Que risque-t-il en cas de refus de céder le passage ?", [
    { text: "135 € d'amende et 4 points au titre du non-respect d'un panneau « cédez le passage » (article R415-7)", correct: true },
    { text: "Aucune sanction, la priorité dans les ronds-points n'étant qu'une convention non écrite", correct: false },
    { text: "35 € d'amende seulement, le rond-point n'étant pas une intersection classique", correct: false },
    { text: "Un simple avertissement, sauf récidive", correct: false },
  ], "Le panneau « cédez le passage » à l'entrée d'un giratoire a la même valeur juridique que partout ailleurs : son non-respect est sanctionné par une amende de 135 € et un retrait de 4 points.", { difficulty: "difficile" }),
  q("priorites", "Sur une place ou un carrefour à sens giratoire annoncé par le panneau spécifique « vous n'avez pas la priorité », la règle applicable est :", [
    { text: "Les véhicules circulant dans l'anneau sont prioritaires sur ceux qui souhaitent s'y engager", correct: true },
    { text: "Les véhicules qui s'engagent sont prioritaires sur ceux déjà présents dans l'anneau", correct: false },
    { text: "La priorité à droite classique continue de s'appliquer à l'intérieur de l'anneau", correct: false },
    { text: "Chaque conducteur applique la règle qu'il juge la plus sûre", correct: false },
  ], "Ce panneau, typique des ronds-points modernes, inverse la priorité à droite traditionnelle : les véhicules déjà engagés dans l'anneau ont la priorité sur ceux qui souhaitent y entrer.", { difficulty: "difficile" }),
  q("priorites", "À un carrefour où un agent de la circulation effectue une régulation manuelle, ses indications priment sur :", [
    { text: "La signalisation lumineuse, les panneaux de priorité et les règles générales du Code de la route", correct: true },
    { text: "Uniquement les feux tricolores, mais pas les panneaux STOP ou cédez le passage", correct: false },
    { text: "Rien, l'agent ne pouvant que suggérer un ordre de passage sans valeur contraignante", correct: false },
    { text: "Les feux tricolores seulement s'ils sont en panne", correct: false },
  ], "Les gestes et signaux d'un agent régulant la circulation ont toujours priorité sur la signalisation lumineuse, les panneaux et les règles générales de priorité, y compris la priorité à droite.", { difficulty: "difficile" }),
  q("priorites", "Un conducteur circule sur une voie où une signalisation temporaire de chantier impose un rétrécissement à une seule voie, gérée par un alternat sans feu ni panneau B15/C18. Qui est prioritaire ?", [
    { text: "Le sens de circulation indiqué comme prioritaire par la signalisation de chantier, ou à défaut celui dont la voie n'est pas rétrécie", correct: true },
    { text: "Aucune priorité ne peut être établie sans feu tricolore : les véhicules doivent se croiser au jugé", correct: false },
    { text: "Le premier véhicule arrivé au niveau du rétrécissement, indépendamment du sens de circulation", correct: false },
    { text: "Le sens montant est toujours prioritaire sur le sens descendant", correct: false },
  ], "Un alternat manuel doit être régi par une signalisation de chantier (panneaux B15/C18 ou piquets K10) précisant le sens prioritaire ; à défaut de cette signalisation, c'est le sens dont la voie reste normale qui conserve la priorité.", { difficulty: "difficile" }),
  q("priorites", "Un cycliste aborde une intersection équipée d'un panneau « cédez le passage cycliste au feu rouge » (le petit panonceau triangulaire avec flèche jaune, dit « M12 »). Que l'autorise-t-il à faire ?", [
    { text: "Franchir le feu rouge dans la direction indiquée par la flèche, à condition de céder le passage aux autres usagers", correct: true },
    { text: "Franchir n'importe quel feu rouge sans restriction de direction", correct: false },
    { text: "S'arrêter obligatoirement même si la voie est libre", correct: false },
    { text: "Rouler sur le trottoir pour éviter le carrefour", correct: false },
  ], "Le panonceau M12, réservé aux cyclistes, les autorise à franchir un feu rouge dans la seule direction indiquée par la flèche (tout droit, à droite ou à gauche selon le modèle), en cédant systématiquement le passage aux autres usagers prioritaires.", { difficulty: "difficile" }),
  q("priorites", "Un automobiliste tourne à gauche à une intersection alors qu'un véhicule arrive en face tout droit. Qui est prioritaire par défaut, en l'absence de signalisation particulière ?", [
    { text: "Le véhicule circulant tout droit en face, qui n'a pas à céder le passage à celui qui tourne", correct: true },
    { text: "Le véhicule qui tourne à gauche, car il doit dégager l'intersection en premier", correct: false },
    { text: "Le véhicule le plus proche du centre du carrefour au moment de l'engagement", correct: false },
    { text: "Les deux véhicules doivent s'arrêter simultanément et négocier le passage", correct: false },
  ], "Un conducteur qui tourne à gauche doit céder le passage aux véhicules circulant en face qui continuent tout droit ou tournent à droite, sauf signalisation contraire (flèche de dégagement notamment).", { difficulty: "difficile" }),
  q("priorites", "Une voie réservée aux transports en commun, taxis et vélos est bordée d'une ligne blanche discontinue. Un automobiliste peut-il l'emprunter ponctuellement ?", [
    { text: "Oui, uniquement pour tourner ou se garer, sur une courte distance, la ligne discontinue l'autorisant", correct: true },
    { text: "Non, cette voie est interdite en toute circonstance aux véhicules particuliers", correct: false },
    { text: "Oui, sans aucune restriction, à tout moment de la journée", correct: false },
    { text: "Oui, uniquement les dimanches et jours fériés", correct: false },
  ], "Une ligne discontinue en bordure de voie réservée signifie que son franchissement ponctuel est toléré (pour tourner ou stationner très brièvement), contrairement à une ligne continue qui l'interdit totalement.", { difficulty: "difficile" }),
  q("priorites", "Sur une route à grande circulation traversant une agglomération, la priorité à droite s'applique-t-elle systématiquement aux intersections avec les rues secondaires ?", [
    { text: "Non, la route à grande circulation reste généralement prioritaire, sauf signalisation contraire à chaque carrefour", correct: true },
    { text: "Oui, la priorité à droite prévaut toujours dès l'entrée en agglomération", correct: false },
    { text: "Non, seule la présence d'un feu tricolore peut donner priorité à la route principale", correct: false },
    { text: "Oui, sauf le dimanche où la route principale redevient prioritaire", correct: false },
  ], "Une route à grande circulation conserve en général son caractère prioritaire même en traversée d'agglomération, matérialisé par une signalisation spécifique à chaque intersection secondaire, écartant la priorité à droite par défaut.", { difficulty: "difficile" }),
  q("priorites", "Deux véhicules arrivent simultanément à une intersection sans aucune signalisation, l'un venant de la droite d'un rond-point sans priorité indiquée mais hors giratoire classique. La règle qui prévaut est :", [
    { text: "La priorité à droite, règle par défaut du Code de la route en l'absence de toute autre indication", correct: true },
    { text: "La priorité au véhicule le plus rapide pour dégager l'intersection", correct: false },
    { text: "La priorité au véhicule transportant le plus de passagers", correct: false },
    { text: "Aucune règle : le passage se fait au jugé mutuel sans base légale", correct: false },
  ], "En l'absence de tout panneau, marquage ou feu, la priorité à droite reste la règle de référence du Code de la route à toute intersection.", { difficulty: "difficile" }),
  q("priorites", "Un panneau « intersection où le conducteur bénéficie de la priorité de passage » (croix de Saint-André jaune sur fond blanc) informe le conducteur que :", [
    { text: "Il conserve sa priorité sur les routes qui débouchent sur la sienne à la prochaine intersection", correct: true },
    { text: "Il doit céder le passage à tous les véhicules venant de sa droite comme de sa gauche", correct: false },
    { text: "L'intersection suivante est équipée d'un feu tricolore", correct: false },
    { text: "Il doit ralentir fortement en prévision d'un carrefour dangereux", correct: false },
  ], "Ce panneau annonce une intersection où le conducteur qui le voit conserve la priorité sur les usagers arrivant des voies transversales, à l'inverse d'un panneau annonçant un carrefour où il devra céder le passage.", { difficulty: "difficile" }),
  q("priorites", "Un automobiliste circule sur une place à sens giratoire matérialisée uniquement par un marquage au sol, sans aucun panneau. Doit-il céder le passage aux véhicules déjà engagés dans l'anneau ?", [
    { text: "Non : en l'absence de panneau « cédez le passage », c'est la priorité à droite qui s'applique, donc les véhicules qui s'engagent sont prioritaires", correct: true },
    { text: "Oui, la logique des ronds-points modernes s'applique automatiquement même sans panneau", correct: false },
    { text: "Cela dépend uniquement de la taille du giratoire", correct: false },
    { text: "Cela dépend du nombre de voies dans l'anneau", correct: false },
  ], "C'est un piège fréquent : sans panneau « cédez le passage » ou « vous n'avez pas la priorité » à l'entrée, un giratoire reste soumis à la priorité à droite classique, contrairement à l'immense majorité des giratoires modernes qui portent ce panneau.", { difficulty: "difficile" }),
  q("vitesse", "Depuis le décret du 22 décembre 2025, un excès de vitesse égal ou supérieur à 50 km/h au-dessus de la limite autorisée est :", [
    { text: "Un délit relevant de l'article L413-1 du Code de la route, et non plus une simple contravention", correct: true },
    { text: "Toujours une contravention de 5e classe, comme avant la réforme", correct: false },
    { text: "Un délit uniquement en cas de récidive dans les 3 ans", correct: false },
    { text: "Une contravention de 4e classe identique aux autres excès de vitesse", correct: false },
  ], "Le décret du 22 décembre 2025 a supprimé les articles R413-14 et R413-14-1 pour ce palier : le grand excès de vitesse (+50 km/h) relève désormais de l'article L413-1 du Code de la route et constitue un délit, avec confiscation du véhicule quasi systématique.", { difficulty: "difficile" }),
  q("vitesse", "Un conducteur est flashé à 175 km/h sur une portion d'autoroute limitée à 110 km/h (soit +65 km/h). Quelle est la conséquence directe de la réforme de décembre 2025 sur son dossier ?", [
    { text: "Il est désormais susceptible de comparaître au tribunal correctionnel et de voir son véhicule confisqué de façon quasi automatique", correct: true },
    { text: "Rien ne change par rapport à l'ancien régime : simple amende forfaitaire de 5e classe", correct: false },
    { text: "Il ne risque plus aucune peine de prison, la réforme ayant supprimé cette possibilité", correct: false },
    { text: "Il conserve tous ses points, la nouvelle qualification ne portant que sur l'amende", correct: false },
  ], "En requalifiant le grand excès de vitesse en délit, la réforme de décembre 2025 permet une comparution devant le tribunal correctionnel et rend la confiscation du véhicule quasi systématique, alors qu'elle restait auparavant exceptionnelle.", { difficulty: "difficile" }),
  q("vitesse", "Sur une route où la visibilité descend sous 50 mètres en raison du brouillard, quelle est la vitesse maximale autorisée, quel que soit le type de route ?", [
    { text: "50 km/h uniformément, y compris sur autoroute", correct: true },
    { text: "70 km/h sur route et 90 km/h sur autoroute", correct: false },
    { text: "La vitesse maximale habituelle de la voie reste inchangée, seule la prudence étant recommandée", correct: false },
    { text: "110 km/h sur autoroute avec seulement une réduction de 20 km/h", correct: false },
  ], "Dès que la visibilité descend sous 50 mètres, une limitation uniforme à 50 km/h s'applique à tous les types de voies, y compris l'autoroute, quelle que soit la limitation habituelle.", { difficulty: "difficile" }),
  q("vitesse", "Depuis le 1er janvier 2024, un excès de vitesse retenu entre 1 et 4 km/h au-dessus de la limite autorisée entraîne-t-il un retrait de points ?", [
    { text: "Non, ce palier n'entraîne plus de retrait de points, seulement une amende", correct: true },
    { text: "Oui, comme tout excès de vitesse, avec un retrait automatique de 1 point", correct: false },
    { text: "Non, cette tranche n'est plus du tout sanctionnée depuis 2024", correct: false },
    { text: "Oui, mais seulement en zone urbaine", correct: false },
  ], "Depuis le 1er janvier 2024, les très faibles excès de vitesse (1 à 4 km/h en vitesse retenue) restent verbalisables par une amende mais ne donnent plus lieu à un retrait de point sur le permis de conduire.", { difficulty: "difficile" }),
  q("vitesse", "Un radar flashe un véhicule roulant à 96 km/h sur une route limitée à 90 km/h. Quelle vitesse sera réellement retenue contre le conducteur, compte tenu de la marge d'erreur technique ?", [
    { text: "91 km/h, compte tenu d'une marge de 5 km/h appliquée en dessous de 100 km/h", correct: true },
    { text: "96 km/h exactement, sans aucune marge de tolérance", correct: false },
    { text: "86 km/h, la marge étant ajoutée à la limite et non retranchée de la vitesse mesurée", correct: false },
    { text: "100 km/h, arrondi au multiple de 10 le plus proche", correct: false },
  ], "Pour les vitesses mesurées inférieures à 100 km/h, une marge d'erreur technique de 5 km/h est retranchée de la vitesse relevée par le radar ; au-delà de 100 km/h, la marge appliquée est proportionnelle (généralement 5 %).", { difficulty: "difficile" }),
  q("vitesse", "En dessous de quel seuil un excès de vitesse constaté en agglomération (limite à 50 km/h) bascule-t-il d'une contravention de 4e classe à une contravention de 3e classe ?", [
    { text: "Cela ne s'applique pas : en zone limitée à 50 km/h ou moins, tout excès reste une contravention de 4e classe", correct: true },
    { text: "En dessous de 20 km/h de dépassement, la contravention est systématiquement de 3e classe", correct: false },
    { text: "En dessous de 10 km/h de dépassement, quelle que soit la vitesse maximale autorisée", correct: false },
    { text: "Ce seuil n'existe pas, toutes les infractions de vitesse étant de 5e classe", correct: false },
  ], "L'ancien article R413-14 prévoyait une contravention de 3e classe pour un dépassement inférieur à 20 km/h uniquement lorsque la vitesse maximale autorisée était supérieure à 50 km/h ; en zone limitée à 50 km/h ou moins, l'infraction reste de 4e classe même pour un faible dépassement.", { difficulty: "difficile" }),
  q("vitesse", "Un jeune conducteur en période probatoire circule sur autoroute. Quelle est sa vitesse maximale autorisée, différente de celle d'un conducteur confirmé ?", [
    { text: "110 km/h au lieu de 130 km/h pour un conducteur confirmé", correct: true },
    { text: "130 km/h, la même limite que pour tout conducteur", correct: false },
    { text: "90 km/h, la limite étant réduite de 40 km/h", correct: false },
    { text: "120 km/h sur autoroute et 100 km/h sur route à deux voies", correct: false },
  ], "Durant la période probatoire, les vitesses maximales sont abaissées : 110 km/h sur autoroute (au lieu de 130), 100 km/h sur route à deux chaussées séparées (au lieu de 110) et 80 km/h sur route bidirectionnelle.", { difficulty: "difficile" }),
  q("vitesse", "Un excès de vitesse compris entre 40 et 50 km/h entraîne un retrait de combien de points, selon le barème actuel ?", [
    { text: "4 points", correct: true },
    { text: "6 points, comme un grand excès de vitesse", correct: false },
    { text: "2 points seulement", correct: false },
    { text: "3 points, comme un excès entre 30 et 40 km/h", correct: false },
  ], "Le barème de retrait de points pour excès de vitesse est progressif : 1 point (moins de 20 km/h en agglomération), 2 points (moins de 20 km/h hors agglomération ou 20-30 km/h), 3 points (30-40 km/h), 4 points (40-50 km/h) et 6 points (50 km/h et plus).", { difficulty: "difficile" }),
  q("vitesse", "Sur une portion d'autoroute où la vitesse est limitée à 130 km/h, un panneau à messages variables affiche « 110 » en raison de fortes pluies. Un conducteur roulant à 125 km/h commet :", [
    { text: "Un excès de vitesse de 15 km/h par rapport à la limite affichée dynamiquement de 110 km/h", correct: true },
    { text: "Aucune infraction, car il respecte la limite fixe de 130 km/h", correct: false },
    { text: "Un excès de vitesse de 5 km/h seulement, calculé par rapport à la limite fixe", correct: false },
    { text: "Une infraction seulement s'il est flashé par un radar mobile et non fixe", correct: false },
  ], "La limite affichée par le panneau à messages variables (110 km/h en cas de fortes pluies) remplace la limite fixe : rouler à 125 km/h constitue donc un excès de 15 km/h, et non de 5 km/h.", { difficulty: "difficile" }),
  q("vitesse", "La distance de freinage d'un véhicule est-elle proportionnelle ou proportionnelle au carré de la vitesse ?", [
    { text: "Elle est proportionnelle au carré de la vitesse : doubler la vitesse multiplie la distance de freinage par 4", correct: true },
    { text: "Elle est strictement proportionnelle à la vitesse : doubler la vitesse double la distance de freinage", correct: false },
    { text: "Elle ne dépend pas de la vitesse mais uniquement de l'état des pneus", correct: false },
    { text: "Elle diminue avec la vitesse en raison de l'effet aérodynamique", correct: false },
  ], "L'énergie cinétique dissipée au freinage croît avec le carré de la vitesse : passer de 50 à 100 km/h ne double pas mais quadruple la distance de freinage théorique sur un revêtement donné.", { difficulty: "difficile" }),
  q("vitesse", "Un conducteur roule à 20 km/h au-dessus de la limite en agglomération (zone limitée à 50 km/h). Quel est le retrait de points applicable ?", [
    { text: "1 point", correct: true },
    { text: "2 points, comme hors agglomération pour le même écart", correct: false },
    { text: "3 points", correct: false },
    { text: "Aucun retrait, seulement une amende", correct: false },
  ], "Un excès de vitesse inférieur à 20 km/h en agglomération (zone où la vitesse maximale autorisée est ≤ 50 km/h) entraîne un retrait de seulement 1 point, contre 2 points pour le même écart hors agglomération.", { difficulty: "difficile" }),
  q("vitesse", "Sur une route bidirectionnelle sans séparateur central, par temps de pluie, quelle est la vitesse maximale autorisée pour un conducteur confirmé (hors probatoire) ?", [
    { text: "80 km/h", correct: true },
    { text: "100 km/h, seule l'autoroute étant concernée par la réduction pluie", correct: false },
    { text: "70 km/h", correct: false },
    { text: "90 km/h, la limite standard restant inchangée sous la pluie", correct: false },
  ], "Sur une route bidirectionnelle sans terre-plein central, la vitesse est déjà limitée à 80 km/h par défaut pour un conducteur confirmé ; en cas de pluie, cette limite de 80 km/h ne change pas car elle est déjà la limite « pluie » de référence sur ce type de voie (110 km/h en conditions normales sur route à chaussées séparées passe à 100 km/h sous la pluie).", { difficulty: "difficile" }),
  q("vitesse", "Une contravention pour grand excès de vitesse (avant la réforme de décembre 2025) pouvait être payée par amende forfaitaire délictuelle (AFD) si :", [
    { text: "Le conducteur était identifié sans ambiguïté et acceptait cette procédure simplifiée évitant le tribunal", correct: true },
    { text: "Le conducteur roulait à moins de 60 km/h au-dessus de la limite", correct: false },
    { text: "Le véhicule était immatriculé à l'étranger", correct: false },
    { text: "L'infraction avait été commise de nuit", correct: false },
  ], "Pour les excès de vitesse de 50 km/h et plus, le parquet peut proposer une amende forfaitaire délictuelle (AFD) lorsque le conducteur est identifié, évitant ainsi une comparution devant le tribunal correctionnel tout en conservant la qualification de délit.", { difficulty: "difficile" }),
  q("vitesse", "Un conducteur circulant à 145 km/h sur autoroute limitée à 130 km/h (soit +15 km/h) risque quelle classe de contravention ?", [
    { text: "Une contravention de 4e classe, l'excès étant inférieur à 20 km/h mais la vitesse maximale autorisée étant supérieure à 50 km/h", correct: false },
    { text: "Une contravention de 3e classe, car l'excès est inférieur à 20 km/h et la vitesse maximale autorisée dépasse 50 km/h", correct: true },
    { text: "Un délit relevant du tribunal correctionnel", correct: false },
    { text: "Une contravention de 5e classe", correct: false },
  ], "L'ancien article R413-14 prévoyait une contravention de 3e classe (et non 4e) lorsque le dépassement est inférieur à 20 km/h ET que la vitesse maximale autorisée dépasse 50 km/h — cas typique d'un léger excès sur autoroute ou voie rapide.", { difficulty: "difficile" }),
  q("vitesse", "En cas de grand excès de vitesse (50 km/h ou plus) commis en récidive légale dans les 3 ans, la peine encourue est :", [
    { text: "Trois mois d'emprisonnement et 3 750 € d'amende, avec confiscation obligatoire du véhicule", correct: true },
    { text: "Identique à la première infraction : simple amende sans peine de prison possible", correct: false },
    { text: "Une peine de prison uniquement si un accident corporel est survenu", correct: false },
    { text: "Un simple doublement de l'amende sans autre conséquence", correct: false },
  ], "La récidive de grand excès de vitesse dans le délai légal de 3 ans est punie de trois mois d'emprisonnement et 3 750 € d'amende, avec confiscation obligatoire du véhicule utilisé pour commettre l'infraction.", { difficulty: "difficile" }),
  q("vitesse", "La distance de sécurité minimale entre deux véhicules qui se suivent est généralement estimée, en conditions normales, à :", [
    { text: "La distance parcourue en 2 secondes à la vitesse pratiquée", correct: true },
    { text: "Une distance fixe de 50 mètres quelle que soit la vitesse", correct: false },
    { text: "La distance parcourue en 5 secondes, quelle que soit la météo", correct: false },
    { text: "Un intervalle d'une longueur de véhicule par tranche de 10 km/h", correct: false },
  ], "La règle des deux secondes est la référence pédagogique pour estimer la distance de sécurité en conditions normales : elle doit être doublée, voire triplée, sur chaussée mouillée ou en cas de visibilité réduite.", { difficulty: "difficile" }),
  q("vitesse", "Un conducteur double la vitesse à laquelle il circulait, passant de 60 à 120 km/h. Sa distance de freinage est, en théorie, multipliée par :", [
    { text: "4, en raison de la relation quadratique entre vitesse et énergie cinétique", correct: true },
    { text: "2, proportionnellement à la vitesse", correct: false },
    { text: "1,5, l'effet n'étant que partiellement proportionnel", correct: false },
    { text: "8, en raison d'un effet cubique", correct: false },
  ], "La distance de freinage étant proportionnelle au carré de la vitesse, doubler la vitesse (de 60 à 120 km/h) multiplie par 4 la distance théorique nécessaire pour immobiliser le véhicule, à adhérence égale.", { difficulty: "difficile" }),
  q("conducteur", "Un conducteur tient son téléphone en main pour consulter l'heure alors qu'il est arrêté à un feu rouge, moteur allumé. Commet-il une infraction ?", [
    { text: "Oui, car un véhicule arrêté à un feu rouge ou dans un embouteillage reste juridiquement « en circulation »", correct: true },
    { text: "Non, l'infraction ne concerne que les véhicules en mouvement", correct: false },
    { text: "Non, seule la lecture d'un message est sanctionnée, pas la consultation de l'heure", correct: false },
    { text: "Oui, mais seulement si le moteur est encore en marche et la boîte en prise", correct: false },
  ], "L'article R412-6-1 s'applique dès que le véhicule est « en circulation », ce qui inclut les arrêts temporaires à un feu rouge ou dans un embouteillage : la simple consultation de l'heure, téléphone en main, suffit à caractériser l'infraction.", { difficulty: "difficile" }),
  q("conducteur", "Quelle est la sanction de base pour usage d'un téléphone tenu en main au volant, hors mesures préfectorales locales ?", [
    { text: "135 € d'amende, 3 points retirés, et une possible suspension de permis jusqu'à 3 ans", correct: true },
    { text: "90 € d'amende sans retrait de points ni suspension possible", correct: false },
    { text: "135 € d'amende et 4 points, comme un refus de priorité", correct: false },
    { text: "35 € d'amende, comme un feu orange grillé", correct: false },
  ], "L'article R412-6-1 sanctionne l'usage d'un téléphone tenu en main par une amende de 4e classe (135 €) et un retrait de 3 points, avec en plus une peine complémentaire possible de suspension du permis pouvant aller jusqu'à 3 ans.", { difficulty: "difficile" }),
  q("conducteur", "Depuis mai 2026, certains préfets (Indre-et-Loire, Drôme, Pas-de-Calais...) ont annoncé une mesure locale renforçant la sanction du téléphone tenu en main. En quoi consiste-t-elle ?", [
    { text: "Une possible suspension administrative immédiate du permis, même sans autre infraction associée", correct: true },
    { text: "Une loi nationale supprimant définitivement le droit de conduire pour toute utilisation du téléphone", correct: false },
    { text: "Un doublement automatique de l'amende à 270 € dans tous les départements français", correct: false },
    { text: "Une interdiction de vendre des téléphones dans les stations-service de ces départements", correct: false },
  ], "Jusqu'alors, la suspension du permis pour téléphone en main n'était possible qu'en cas de cumul avec une autre infraction. Plusieurs préfets ont pris des arrêtés locaux permettant, dans leur département, une suspension immédiate même sans infraction associée.", { difficulty: "difficile" }),
  q("conducteur", "Pour un conducteur en permis probatoire, à partir de quel taux d'alcoolémie dans le sang l'infraction est-elle constituée, contre 0,5 g/l pour un conducteur confirmé ?", [
    { text: "0,2 g/l de sang (0,10 mg/l d'air expiré)", correct: true },
    { text: "0,5 g/l, le même seuil que pour tout conducteur", correct: false },
    { text: "0 g/l strictement, tolérance zéro absolue sans aucune marge", correct: false },
    { text: "0,3 g/l de sang", correct: false },
  ], "Depuis le 1er juillet 2015, le seuil d'alcoolémie tolérée pour les conducteurs en période probatoire est abaissé à 0,2 g/l de sang (0,10 mg/l d'air expiré), contre 0,5 g/l pour un conducteur confirmé — ce qui correspond en pratique à zéro verre d'alcool.", { difficulty: "difficile" }),
  q("conducteur", "Un jeune conducteur en première année de permis probatoire est contrôlé avec un taux d'alcoolémie de 0,3 g/l de sang. Quelle en est la conséquence sur son capital de points ?", [
    { text: "Retrait de 6 points, ce qui invalide immédiatement son permis pour solde nul (il ne dispose que de 6 points)", correct: true },
    { text: "Retrait de 3 points seulement, son permis étant préservé avec 3 points restants", correct: false },
    { text: "Aucun retrait de points la première année, seule une amende étant appliquée", correct: false },
    { text: "Retrait de 6 points mais sans invalidation, un sursis étant automatique en première année", correct: false },
  ], "Une infraction d'alcoolémie entre 0,2 et 0,8 g/l entraîne un retrait de 6 points. Or un permis probatoire ne dispose au départ que de 6 points : ce retrait entraîne donc l'invalidation immédiate du permis pour solde nul, sans possibilité de stage de récupération à ce stade.", { difficulty: "difficile" }),
  q("conducteur", "Contrairement à l'alcool, la conduite après usage de stupéfiants (article L235-1) est sanctionnée :", [
    { text: "Dès la présence détectable de la substance dans l'organisme, sans aucun seuil légal comparable à celui de l'alcool", correct: true },
    { text: "Uniquement au-delà d'un seuil de concentration précis fixé par décret, comme pour l'alcool", correct: false },
    { text: "Seulement en cas d'accident corporel constaté", correct: false },
    { text: "Uniquement si le conducteur reconnaît volontairement sa consommation", correct: false },
  ], "Il n'existe aucun seuil légal pour les stupéfiants : la simple présence détectable d'une substance classée stupéfiant dans le sang ou la salive suffit à caractériser le délit, contrairement à l'alcool pour lequel un seuil précis est fixé.", { difficulty: "difficile" }),
  q("conducteur", "Depuis la loi du 9 juillet 2025, la conduite après usage de stupéfiants seuls est punie de :", [
    { text: "3 ans d'emprisonnement et 9 000 € d'amende", correct: true },
    { text: "2 ans d'emprisonnement et 4 500 € d'amende, comme auparavant", correct: false },
    { text: "1 an d'emprisonnement et 15 000 € d'amende", correct: false },
    { text: "5 ans d'emprisonnement et 9 000 € d'amende", correct: false },
  ], "La loi du 9 juillet 2025 a alourdi la peine de base pour conduite après usage de stupéfiants, désormais fixée à 3 ans d'emprisonnement et 9 000 € d'amende (contre 2 ans et 4 500 € auparavant).", { difficulty: "difficile" }),
  q("conducteur", "En cas de cumul entre alcool et stupéfiants au volant, la peine encourue et le retrait de points sont :", [
    { text: "Jusqu'à 5 ans d'emprisonnement, 15 000 € d'amende, et un retrait de 9 points — seule exception au plafond habituel de 8 points cumulés", correct: true },
    { text: "Identiques à une simple infraction d'alcool seul : 6 points et 4 500 € d'amende", correct: false },
    { text: "6 ans d'emprisonnement, 18 000 € d'amende, et un retrait de 12 points", correct: false },
    { text: "3 ans d'emprisonnement, 9 000 € d'amende, et un retrait de 6 points, sans majoration liée au cumul", correct: false },
  ], "Le cumul alcool et stupéfiants porte la peine à 5 ans d'emprisonnement et 15 000 € d'amende, avec un retrait de 9 points sur le permis — un cas unique qui déroge au plafond habituel de 8 points pouvant être retirés pour une infraction, fixé par l'article L223-2.", { difficulty: "difficile" }),
  q("conducteur", "Le capital de points initial d'un permis probatoire, avant toute majoration annuelle, est de :", [
    { text: "6 points, contre 12 points pour un permis définitif", correct: true },
    { text: "8 points", correct: false },
    { text: "4 points", correct: false },
    { text: "12 points, identique à un permis classique dès l'obtention", correct: false },
  ], "L'article L223-1 du Code de la route prévoit qu'à l'obtention du permis, celui-ci est affecté de la moitié du nombre maximal de points, soit 6 points sur 12, durant toute la période probatoire.", { difficulty: "difficile" }),
  q("conducteur", "Un titulaire d'un permis probatoire obtenu après un apprentissage classique (hors conduite accompagnée) voit son capital de points progresser comment, en l'absence de toute infraction ?", [
    { text: "6 points la 1re année, 8 points la 2e, 10 points la 3e, puis 12 points au terme de la 3e année", correct: true },
    { text: "6, 9, puis 12 points sur seulement 2 ans", correct: false },
    { text: "6 points fixes pendant 3 ans, puis un saut direct à 12 points", correct: false },
    { text: "6, 10, puis 12 points sur 2 ans", correct: false },
  ], "Pour un permis probatoire classique (3 ans, hors conduite accompagnée), le capital augmente de 2 points à chaque date anniversaire sans infraction : 6, puis 8, puis 10, pour atteindre 12 points au terme de la 3e année.", { difficulty: "difficile" }),
  q("conducteur", "Un conducteur en permis probatoire perd 2 points au cours de sa première année (infraction mineure). Quel est l'effet sur le mécanisme de majoration annuelle des points ?", [
    { text: "La majoration annuelle est interrompue et se bloque au niveau atteint jusqu'à la fin de la période probatoire", correct: true },
    { text: "Seule cette année-là est affectée : la majoration reprend normalement l'année suivante", correct: false },
    { text: "Aucun effet : la majoration continue indépendamment des infractions commises", correct: false },
    { text: "Le capital repart automatiquement à 6 points, comme au premier jour du permis", correct: false },
  ], "Toute infraction entraînant un retrait de points bloque le mécanisme de majoration annuelle pour le reste de la période probatoire : le conducteur ne bénéficiera plus des paliers de 2 points supplémentaires, même s'il ne commet plus d'infraction ensuite.", { difficulty: "difficile" }),
  q("conducteur", "Depuis la loi n° 2025-622 du 9 juillet 2025, un accident mortel causé par un conducteur avec une circonstance aggravante (alcool, stupéfiants...) est désormais qualifié de :", [
    { text: "Homicide routier, délit autonome distinct de l'homicide involontaire, puni de 7 ans d'emprisonnement et 100 000 € d'amende", correct: true },
    { text: "Homicide involontaire aggravé, sans changement de qualification pénale par rapport à avant 2025", correct: false },
    { text: "Blessures routières, quelle que soit l'issue de l'accident", correct: false },
    { text: "Délit de fuite aggravé, indépendamment des circonstances de l'accident", correct: false },
  ], "La loi du 9 juillet 2025 crée le délit autonome d'homicide routier (articles 221-18 et suivants du Code pénal), distinct de l'homicide involontaire classique, avec une peine de base de 7 ans d'emprisonnement et 100 000 € d'amende.", { difficulty: "difficile" }),
  q("conducteur", "En cas d'homicide routier commis avec deux circonstances aggravantes ou plus (par exemple alcool et grand excès de vitesse cumulés), la peine maximale encourue est :", [
    { text: "10 ans d'emprisonnement et 150 000 € d'amende", correct: true },
    { text: "7 ans d'emprisonnement et 100 000 € d'amende, sans majoration liée au cumul de circonstances", correct: false },
    { text: "15 ans d'emprisonnement, peine réservée aux crimes", correct: false },
    { text: "5 ans d'emprisonnement et 75 000 € d'amende, peine de l'ancien homicide involontaire", correct: false },
  ], "Lorsque l'homicide routier est commis avec deux circonstances aggravantes ou plus parmi celles listées par la loi (alcool, stupéfiants, grand excès de vitesse, délit de fuite...), la peine est portée à 10 ans d'emprisonnement et 150 000 € d'amende.", { difficulty: "difficile" }),
  q("conducteur", "Un conducteur cause un accident mortel sans qu'aucune circonstance aggravante (alcool, stupéfiants, grand excès de vitesse...) ne soit caractérisée. Quelle qualification pénale reste applicable ?", [
    { text: "L'homicide involontaire classique de l'article 221-6-1 du Code pénal, puni de 5 ans d'emprisonnement et 75 000 € d'amende", correct: true },
    { text: "L'homicide routier s'applique automatiquement dès qu'il y a un mort, indépendamment des circonstances", correct: false },
    { text: "Aucune poursuite pénale n'est possible en l'absence de circonstance aggravante", correct: false },
    { text: "Les blessures routières, qualification utilisée par défaut", correct: false },
  ], "L'homicide routier ne remplace pas l'homicide involontaire : il ne s'applique qu'en présence d'au moins une circonstance aggravante définie par la loi. En son absence, c'est l'article 221-6-1 du Code pénal (5 ans, 75 000 €) qui continue de s'appliquer.", { difficulty: "difficile" }),
  q("conducteur", "Refuser de se soumettre aux vérifications de dépistage d'alcoolémie ou de stupéfiants (article L235-3 / L234-8) constitue :", [
    { text: "Un délit autonome puni aussi sévèrement qu'une conduite positive avérée : jusqu'à 2 ans d'emprisonnement et 4 500 € d'amende", correct: true },
    { text: "Une simple contravention de 4e classe, moins grave qu'une conduite positive", correct: false },
    { text: "Une infraction sans conséquence sur le permis, seul le refus de contrôle routier général étant sanctionné", correct: false },
    { text: "Un motif de nullité systématique de la procédure, protégeant le conducteur de toute poursuite", correct: false },
  ], "Le refus de se soumettre aux vérifications est traité par la loi aussi sévèrement qu'une conduite positive : jusqu'à 2 ans d'emprisonnement et 4 500 € d'amende, précisément pour éviter que le refus ne devienne une stratégie d'évitement des sanctions.", { difficulty: "difficile" }),
  q("conducteur", "Un stage de sensibilisation à la sécurité routière suivi volontairement permet à un conducteur en permis probatoire de récupérer au maximum :", [
    { text: "4 points, dans la limite du plafond de points en vigueur pour son permis (6 en probatoire, 12 hors probatoire)", correct: true },
    { text: "12 points d'un coup, quel que soit le solde initial", correct: false },
    { text: "2 points seulement, contre 4 points hors période probatoire", correct: false },
    { text: "Un nombre de points illimité si plusieurs stages sont suivis la même année", correct: false },
  ], "Un stage de sensibilisation permet de récupérer jusqu'à 4 points, mais toujours dans la limite du plafond du permis concerné (6 points en période probatoire, 12 points hors probatoire), et seulement une fois par an.", { difficulty: "difficile" }),
  q("conducteur", "Un conducteur perd son permis pour solde de points nul (invalidation) durant sa période probatoire. Doit-il repasser uniquement l'épreuve pratique ou l'intégralité du permis ?", [
    { text: "L'intégralité du permis : l'épreuve du code et celle de la conduite", correct: true },
    { text: "Uniquement l'épreuve pratique de conduite, le code restant acquis à vie", correct: false },
    { text: "Aucune épreuve : le permis est restitué automatiquement après un délai de 6 mois", correct: false },
    { text: "Uniquement un contrôle médical, sans repasser d'examen", correct: false },
  ], "En cas d'invalidation pour solde de points nul, quelle que soit la période (probatoire ou non), le conducteur doit repasser l'intégralité du permis de conduire : épreuve théorique (code) et épreuve pratique.", { difficulty: "difficile" }),
  q("usagers", "Quelle distance latérale minimale un automobiliste doit-il respecter en dépassant un cycliste hors agglomération ?", [
    { text: "1,50 mètre", correct: true },
    { text: "1 mètre, la même distance qu'en agglomération", correct: false },
    { text: "2 mètres", correct: false },
    { text: "0,50 mètre", correct: false },
  ], "L'article R414-4 impose une distance latérale minimale de 1 mètre en agglomération et de 1,50 mètre hors agglomération lors du dépassement d'un cycliste, d'un piéton, d'un cavalier ou d'un véhicule à traction animale.", { difficulty: "difficile" }),
  q("usagers", "Le non-respect de la distance minimale de dépassement d'un cycliste (article R414-4) est sanctionné par :", [
    { text: "135 € d'amende et 3 points retirés", correct: true },
    { text: "35 € d'amende sans retrait de points", correct: false },
    { text: "135 € d'amende sans aucun retrait de points", correct: false },
    { text: "750 € d'amende systématiquement, quelle que soit la gravité", correct: false },
  ], "Le non-respect de la distance de sécurité latérale lors du dépassement d'un cycliste est une contravention de 4e classe : 135 € d'amende forfaitaire et 3 points retirés sur le permis.", { difficulty: "difficile" }),
  q("usagers", "Si la distance latérale réglementaire ne peut pas être respectée en toute sécurité lors du dépassement d'un cycliste, que doit faire le conducteur ?", [
    { text: "Reporter son dépassement jusqu'à ce que la manœuvre puisse être effectuée en toute sécurité", correct: true },
    { text: "Klaxonner pour inciter le cycliste à se rabattre sur le bas-côté", correct: false },
    { text: "Réduire légèrement la distance tout en accélérant pour raccourcir le temps d'exposition", correct: false },
    { text: "Dépasser quand même, la distance étant une simple recommandation et non une obligation", correct: false },
  ], "L'article R414-4 est une règle intransigeante : si la distance minimale (1 m en ville, 1,50 m hors agglomération) ne peut être garantie, le dépassement doit être différé, sans exception liée à l'urgence du conducteur.", { difficulty: "difficile" }),
  q("usagers", "Un poids lourd effectue un virage à droite. Un cycliste ou un piéton situé dans son angle mort avant-droit :", [
    { text: "Peut ne pas être vu du tout par le conducteur, même en vérifiant ses rétroviseurs, d'où le risque mortel de l'angle mort", correct: true },
    { text: "Est toujours visible grâce aux rétroviseurs grand angle obligatoires sur tous les poids lourds depuis 2015", correct: false },
    { text: "N'est en danger que si le poids lourd roule à plus de 30 km/h", correct: false },
    { text: "Est protégé automatiquement par un système de détection radar obligatoire sur tous les camions", correct: false },
  ], "Malgré les rétroviseurs additionnels, l'angle mort avant-droit des poids lourds reste une zone où un piéton ou un cycliste peut totalement échapper à la vue du conducteur, ce qui explique la majorité des accidents mortels lors des virages à droite en ville.", { difficulty: "difficile" }),
  q("usagers", "Un piéton s'engage sur un passage protégé alors que le feu piéton est encore rouge, mais aucun véhicule n'arrive. Un automobiliste qui le percute a-t-il automatiquement raison sur le plan de la responsabilité ?", [
    { text: "Non : la loi protège fortement les piétons, et le conducteur reste en général responsable sauf faute inexcusable du piéton", correct: true },
    { text: "Oui, un piéton traversant au rouge perd systématiquement tout droit à indemnisation", correct: false },
    { text: "Oui, la responsabilité est automatiquement partagée à 50/50 dans tous les cas", correct: false },
    { text: "Non, mais uniquement si le piéton est mineur", correct: false },
  ], "La loi Badinter protège fortement les piétons, y compris fautifs : le conducteur reste presque toujours responsable de l'indemnisation, sauf en cas de faute inexcusable du piéton qui serait la cause exclusive de l'accident — une exception rarement retenue par les tribunaux.", { difficulty: "difficile" }),
  q("usagers", "Un automobiliste s'apprête à dépasser un cavalier sur une route étroite. Quelle règle spécifique s'applique en plus de la distance latérale ?", [
    { text: "Il doit adapter sa vitesse et éviter tout bruit soudain (klaxon, accélération) susceptible d'effrayer le cheval", correct: true },
    { text: "Il doit s'arrêter obligatoirement et attendre que le cavalier descende de cheval", correct: false },
    { text: "Aucune règle spécifique ne s'applique en dehors de la distance latérale générale", correct: false },
    { text: "Il doit obligatoirement klaxonner avant de dépasser pour prévenir le cavalier", correct: false },
  ], "Au-delà de la distance latérale minimale identique à celle d'un cycliste, la prudence impose d'éviter tout bruit ou geste brusque susceptible d'effrayer l'animal, qui pourrait réagir de façon imprévisible et dangereuse.", { difficulty: "difficile" }),
  q("usagers", "Un motocycliste circule entre deux files de voitures à l'arrêt dans un bouchon (pratique dite « interfiling »). Sur le plan légal actuel en France :", [
    { text: "Cette pratique n'est pas expressément autorisée par un texte pérenne et reste risquée juridiquement en cas d'accident", correct: true },
    { text: "Elle est totalement légale et encadrée par un panneau spécifique depuis 2021", correct: false },
    { text: "Elle est interdite uniquement sur autoroute mais autorisée en ville", correct: false },
    { text: "Elle est autorisée à condition de ne pas dépasser 30 km/h", correct: false },
  ], "Contrairement à une croyance répandue, aucun texte pérenne ne généralise et n'encadre clairement l'interfiling en France : les motards qui le pratiquent restent en zone d'incertitude juridique, notamment en matière de responsabilité en cas d'accident.", { difficulty: "difficile" }),
  q("usagers", "Un utilisateur de trottinette électrique en libre-service (EDPM) doit-il respecter les mêmes règles de priorité aux intersections qu'un cycliste ?", [
    { text: "Oui, les engins de déplacement personnel motorisés (EDPM) sont soumis aux mêmes règles de circulation que les cycles", correct: true },
    { text: "Non, les trottinettes ne sont soumises à aucune règle de priorité, étant assimilées aux piétons", correct: false },
    { text: "Non, elles doivent systématiquement s'arrêter à toutes les intersections, contrairement aux cyclistes", correct: false },
    { text: "Cela dépend uniquement de la vitesse à laquelle circule l'utilisateur", correct: false },
  ], "Les engins de déplacement personnel motorisés (EDPM), catégorie qui inclut les trottinettes électriques, sont juridiquement assimilés aux cycles pour les règles de circulation, y compris les règles de priorité aux intersections.", { difficulty: "difficile" }),
  q("usagers", "Un automobiliste double un groupe de cyclistes roulant en peloton sur une route à double sens. Un cycliste isolé se trouve juste après le groupe, à quelques mètres. Que doit faire le conducteur ?", [
    { text: "Considérer l'ensemble comme un seul obstacle continu et maintenir la distance latérale sur toute la manœuvre, y compris pour le cycliste isolé", correct: true },
    { text: "Se rabattre dès la fin du peloton, avant même d'avoir dépassé le cycliste isolé qui suit", correct: false },
    { text: "Accélérer fortement pour limiter le temps d'exposition, quitte à réduire temporairement la distance latérale", correct: false },
    { text: "Klaxonner pour signaler sa présence à chaque cycliste dépassé individuellement", correct: false },
  ], "Un peloton suivi de près par un cycliste isolé doit être traité comme un ensemble continu : le conducteur doit maintenir la distance de sécurité jusqu'à avoir dépassé la totalité du groupe, cycliste isolé compris.", { difficulty: "difficile" }),
  q("usagers", "Un piéton muni d'une canne blanche s'apprête à traverser à un passage protégé sans feu de signalisation. Quelle est l'obligation du conducteur ?", [
    { text: "S'arrêter pour le laisser traverser, la canne blanche imposant une vigilance renforcée au-delà de l'obligation générale de céder le passage", correct: true },
    { text: "Ralentir seulement, sans obligation de s'arrêter complètement", correct: false },
    { text: "Klaxonner pour signaler sa présence avant de poursuivre sa route", correct: false },
    { text: "Aucune obligation spécifique différente de celle applicable à tout piéton", correct: false },
  ], "Au-delà de l'obligation générale de céder le passage aux piétons engagés sur un passage protégé, la présence d'une canne blanche signale une personne en situation de handicap visuel et impose une vigilance et une prudence accrues du conducteur.", { difficulty: "difficile" }),
  q("usagers", "Un cycliste circule de nuit sans éclairage réglementaire. Quelle sanction risque-t-il pour chaque équipement obligatoire manquant ?", [
    { text: "Une amende forfaitaire de 11 € par équipement réglementaire manquant", correct: true },
    { text: "135 € d'amende et un retrait de points sur son permis de conduire automobile", correct: false },
    { text: "Aucune sanction, les cyclistes n'étant pas soumis à des obligations d'éclairage", correct: false },
    { text: "Une amende de 375 € et la confiscation immédiate du vélo", correct: false },
  ], "Un cycliste circulant de nuit ou en cas de visibilité insuffisante sans l'éclairage réglementaire (avant, arrière, catadioptres) s'expose à une amende forfaitaire de 11 € par équipement manquant lors d'un contrôle.", { difficulty: "difficile" }),
  q("usagers", "Un automobiliste veut tourner à droite alors qu'un cycliste circule tout droit sur une bande cyclable située à sa droite. Qui est prioritaire ?", [
    { text: "Le cycliste qui continue tout droit sur la bande cyclable, l'automobiliste devant céder le passage avant de tourner", correct: true },
    { text: "L'automobiliste, qui a engagé sa manœuvre de virage en premier", correct: false },
    { text: "Cela dépend uniquement de la vitesse respective des deux usagers", correct: false },
    { text: "Aucun des deux : la priorité doit être négociée au cas par cas", correct: false },
  ], "Un conducteur qui souhaite tourner à droite et croise une bande ou piste cyclable doit céder le passage au cycliste qui continue tout droit, exactement comme il devrait le faire face à un autre véhicule circulant en ligne droite.", { difficulty: "difficile" }),
  q("usagers", "La présence d'un enfant à vélo, seul, sur le trottoir est-elle autorisée par le Code de la route ?", [
    { text: "Oui, jusqu'à l'âge de 8 ans révolus, à condition d'allure modérée et sans gêner les piétons", correct: true },
    { text: "Non, un vélo est interdit sur les trottoirs quel que soit l'âge du cycliste", correct: false },
    { text: "Oui, sans limite d'âge, tant que le trottoir est suffisamment large", correct: false },
    { text: "Oui, mais uniquement s'il est accompagné d'un adulte à pied", correct: false },
  ], "Le Code de la route autorise les enfants de moins de 8 ans à circuler à vélo sur le trottoir, à condition de rouler à une allure modérée et de ne pas gêner la circulation des piétons.", { difficulty: "difficile" }),
  q("usagers", "Un automobiliste ouvre sa portière côté circulation sans vérifier son rétroviseur, blessant un cycliste qui passait. Quelle règle a-t-il enfreinte ?", [
    { text: "L'obligation de s'assurer, avant d'ouvrir une portière, qu'aucun danger ne résulte de cette manœuvre pour les autres usagers", correct: true },
    { text: "Aucune règle spécifique, l'ouverture de portière n'étant pas encadrée par le Code de la route", correct: false },
    { text: "Une simple règle de courtoisie sans valeur juridique contraignante", correct: false },
    { text: "Une règle qui ne s'applique qu'aux véhicules professionnels (taxis, VTC)", correct: false },
  ], "Le Code de la route impose au conducteur comme aux passagers de s'assurer qu'ils peuvent ouvrir une portière sans danger ni gêne pour les autres usagers, notamment les cyclistes circulant le long du véhicule ; ce type d'accident (« emportiérage ») engage la responsabilité de celui qui ouvre la portière.", { difficulty: "difficile" }),
  q("usagers", "Sur une voie partagée où cyclistes et automobilistes circulent (chaucidou), l'automobiliste qui croise un cycliste en sens inverse doit :", [
    { text: "Ralentir et, si nécessaire, empiéter légèrement sur la bande centrale ou se déporter pour maintenir une distance suffisante", correct: true },
    { text: "Forcer le cycliste à s'arrêter en bordure de chaussée avant de le croiser", correct: false },
    { text: "Klaxonner obligatoirement avant tout croisement avec un cycliste", correct: false },
    { text: "S'arrêter complètement jusqu'à ce que le cycliste soit passé", correct: false },
  ], "Sur une chaussée à voie centrale banalisée (chaucidou), l'automobiliste doit adapter sa trajectoire et sa vitesse pour croiser le cycliste en toute sécurité, ce qui implique souvent de ralentir et de se déporter légèrement.", { difficulty: "difficile" }),
  q("usagers", "Un utilisateur de gyroroue ou de monoroue électrique est-il juridiquement assimilé à un piéton ou à un cycliste ?", [
    { text: "À un cycliste, en tant qu'engin de déplacement personnel motorisé (EDPM), et non à un piéton", correct: true },
    { text: "À un piéton, ces engins étant assimilés à un simple prolongement de la marche à pied", correct: false },
    { text: "À aucun des deux : ces engins échappent à toute réglementation du Code de la route", correct: false },
    { text: "Cela dépend uniquement de la vitesse maximale de l'engin", correct: false },
  ], "Les gyroroues et monoroues électriques entrent dans la catégorie des engins de déplacement personnel motorisés (EDPM), soumis aux règles de circulation applicables aux cycles, et non à celles des piétons.", { difficulty: "difficile" }),
  q("secours", "Un automobiliste témoin d'un accident de la route s'éloigne sans porter assistance à une victime consciente et en danger, alors qu'il aurait pu agir sans risque pour lui-même. Quelle infraction pénale risque-t-il ?", [
    { text: "La non-assistance à personne en danger (article 223-6 du Code pénal), punie de 5 ans d'emprisonnement et 75 000 € d'amende", correct: true },
    { text: "Un simple défaut d'assurance, sanctionné par une amende de 3 750 €", correct: false },
    { text: "Aucune infraction s'il n'est pas responsable de l'accident", correct: false },
    { text: "Une contravention de 4e classe uniquement", correct: false },
  ], "L'article 223-6 du Code pénal sanctionne l'abstention volontaire de porter assistance à une personne en péril, alors que cela pouvait être fait sans risque pour soi-même ou pour autrui, par 5 ans d'emprisonnement et 75 000 € d'amende.", { difficulty: "difficile" }),
  q("secours", "La peine encourue pour non-assistance à personne en danger est-elle aggravée lorsque la victime est un mineur de moins de 15 ans ?", [
    { text: "Oui, la peine passe alors à 7 ans d'emprisonnement et 100 000 € d'amende", correct: true },
    { text: "Non, la peine reste strictement identique quel que soit l'âge de la victime", correct: false },
    { text: "Oui, mais uniquement l'amende est augmentée, la peine de prison restant à 5 ans", correct: false },
    { text: "Non, l'âge de la victime n'a aucune incidence sur la qualification pénale", correct: false },
  ], "L'article 223-6 du Code pénal prévoit une aggravation de la peine à 7 ans d'emprisonnement et 100 000 € d'amende lorsque la personne en péril est un mineur de quinze ans.", { difficulty: "difficile" }),
  q("secours", "Pour caractériser le délit de non-assistance à personne en danger, quelle condition essentielle doit être réunie concernant le risque encouru par le témoin ?", [
    { text: "L'assistance devait pouvoir être portée sans risque pour le témoin lui-même ou pour des tiers", correct: true },
    { text: "Le témoin doit obligatoirement avoir des compétences médicales pour être poursuivi", correct: false },
    { text: "Aucune condition de risque n'est prise en compte, l'obligation d'agir étant absolue", correct: false },
    { text: "La victime doit être un parent ou un proche du témoin", correct: false },
  ], "Le texte prévoit explicitement que l'assistance doit pouvoir être portée « sans risque pour lui ou pour les tiers » : la loi n'exige jamais qu'un témoin mette sa propre sécurité en danger pour porter secours.", { difficulty: "difficile" }),
  q("secours", "Un simple appel aux services de secours (15, 18 ou 112), sans intervention physique directe, suffit-il à écarter le délit de non-assistance à personne en danger ?", [
    { text: "Oui, alerter les secours qualifiés constitue une assistance suffisante au sens de l'article 223-6", correct: true },
    { text: "Non, une intervention physique directe est toujours exigée, quelle que soit la situation", correct: false },
    { text: "Oui, mais uniquement si l'appel est passé dans les 5 minutes suivant l'accident", correct: false },
    { text: "Non, le simple appel n'a de valeur que s'il est suivi d'un massage cardiaque", correct: false },
  ], "Provoquer un secours, notamment en alertant les services d'urgence, constitue une des deux formes d'assistance prévues par l'article 223-6 : elle suffit à satisfaire l'obligation légale, sans qu'une intervention physique directe soit exigée.", { difficulty: "difficile" }),
  q("secours", "En cas d'accident, la loi du 9 juillet 2025 crée le délit de « blessures routières » distinct de l'homicide routier. À partir de quel seuil d'incapacité totale de travail (ITT) la peine passe-t-elle de 3 à 5 ans d'emprisonnement ?", [
    { text: "Au-delà de 3 mois d'ITT", correct: true },
    { text: "Au-delà de 8 jours d'ITT", correct: false },
    { text: "Au-delà d'un an d'ITT", correct: false },
    { text: "Dès le premier jour d'ITT, sans seuil intermédiaire", correct: false },
  ], "La loi distingue deux niveaux : les blessures routières avec ITT inférieure à 3 mois sont punies de 3 ans d'emprisonnement et 45 000 € d'amende, tandis qu'une ITT supérieure à 3 mois porte la peine à 5 ans d'emprisonnement et 75 000 € d'amende.", { difficulty: "difficile" }),
  q("secours", "Un conducteur impliqué dans un accident corporel doit se soumettre à un examen médical d'aptitude à la conduite dans quel délai, lorsque son état laisse présumer une incompatibilité avec la conduite ?", [
    { text: "72 heures à compter de l'accident, ou à compter du moment où son état de santé le permet", correct: true },
    { text: "30 jours, délai standard pour tout examen médical lié au permis", correct: false },
    { text: "Immédiatement sur les lieux de l'accident, sans délai possible", correct: false },
    { text: "Aucun délai n'est fixé par la loi, l'examen restant facultatif", correct: false },
  ], "L'article L232-4 du Code de la route, issu de la loi du 9 juillet 2025, impose un examen médical réalisé dans un délai de 72 heures à compter de l'accident ou, si l'état de santé ne le permettait pas, à compter du moment où il le permet.", { difficulty: "difficile" }),
  q("secours", "Lorsque les circonstances d'un accident laissent présumer une incompatibilité entre l'état du conducteur et la conduite, que peuvent faire les forces de l'ordre concernant le permis de conduire ?", [
    { text: "Le retenir à titre conservatoire jusqu'à la réalisation de l'examen médical d'aptitude", correct: true },
    { text: "L'annuler immédiatement et définitivement sans procédure judiciaire", correct: false },
    { text: "Rien : seul un juge peut décider d'une mesure sur le permis", correct: false },
    { text: "Le suspendre pour une durée fixe de 6 mois sans possibilité de recours", correct: false },
  ], "L'article L232-4 permet aux officiers et agents de police judiciaire de retenir à titre conservatoire le permis de conduire jusqu'à la réalisation de l'examen médical destiné à déterminer l'aptitude à la conduite.", { difficulty: "difficile" }),
  q("secours", "Face à une victime inconsciente qui respire normalement après un accident de la route, quel geste de premiers secours est recommandé en priorité, en l'absence de personnel médical ?", [
    { text: "La placer en position latérale de sécurité (PLS) pour libérer ses voies respiratoires", correct: true },
    { text: "Lui faire boire de l'eau pour la réhydrater rapidement", correct: false },
    { text: "La redresser en position assise pour faciliter sa respiration", correct: false },
    { text: "Pratiquer immédiatement un massage cardiaque, quelle que soit sa respiration", correct: false },
  ], "Une victime inconsciente qui respire doit être placée en position latérale de sécurité afin de prévenir l'obstruction des voies aériennes par la chute de la langue ou une éventuelle régurgitation, en attendant les secours.", { difficulty: "difficile" }),
  q("secours", "Un massage cardiaque externe est-il recommandé sur une victime inconsciente qui respire normalement ?", [
    { text: "Non, le massage cardiaque n'est indiqué qu'en l'absence de respiration (arrêt cardio-respiratoire)", correct: true },
    { text: "Oui, systématiquement dès qu'une victime est inconsciente, quelle que soit sa respiration", correct: false },
    { text: "Oui, mais uniquement en alternance avec la position latérale de sécurité", correct: false },
    { text: "Cela dépend uniquement de l'âge de la victime", correct: false },
  ], "Le massage cardiaque n'est indiqué qu'en cas d'arrêt cardio-respiratoire, c'est-à-dire lorsque la victime ne respire pas ; une victime inconsciente qui respire doit être placée en PLS, et non massée.", { difficulty: "difficile" }),
  q("secours", "Quel est le numéro d'urgence européen unique, joignable gratuitement depuis tout téléphone, y compris verrouillé, dans l'ensemble de l'Union européenne ?", [
    { text: "Le 112", correct: true },
    { text: "Le 18, valable uniquement en France pour les pompiers", correct: false },
    { text: "Le 15, réservé exclusivement au SAMU en France", correct: false },
    { text: "Le 911, numéro nord-américain non valable en Europe", correct: false },
  ], "Le 112 est le numéro d'urgence unique européen, gratuit, accessible depuis tout téléphone fixe ou mobile (même verrouillé ou sans carte SIM active) dans l'ensemble des pays de l'Union européenne.", { difficulty: "difficile" }),
  q("secours", "Un conducteur doit s'arrêter sur la bande d'arrêt d'urgence d'autoroute après une panne. Quelle est la procédure de sécurité recommandée avant de sortir du véhicule ?", [
    { text: "Enfiler le gilet de haute visibilité avant de sortir, puis se mettre à l'abri derrière les glissières de sécurité", correct: true },
    { text: "Rester dans le véhicule avec les warnings allumés en attendant les secours", correct: false },
    { text: "Sortir immédiatement sans gilet pour signaler le danger le plus rapidement possible aux autres usagers", correct: false },
    { text: "Placer le triangle de signalisation avant d'enfiler le gilet", correct: false },
  ], "La procédure de sécurité recommande d'enfiler le gilet haute visibilité avant même de sortir du véhicule, puis de se mettre à l'abri derrière les glissières, l'espace de la bande d'arrêt d'urgence restant extrêmement dangereux.", { difficulty: "difficile" }),
  q("secours", "Une victime consciente présente une hémorragie externe abondante au bras. Quel geste de premiers secours doit être réalisé en priorité, en l'absence de secours professionnels ?", [
    { text: "Comprimer directement la plaie avec un tissu propre ou la main pour stopper le saignement", correct: true },
    { text: "Appliquer un garrot systématiquement, quelle que soit la localisation de la plaie", correct: false },
    { text: "Surélever uniquement le membre sans exercer de compression", correct: false },
    { text: "Nettoyer la plaie à l'eau avant toute autre action", correct: false },
  ], "La compression directe de la plaie est le geste prioritaire et le plus efficace pour stopper une hémorragie externe ; le garrot n'est réservé qu'aux hémorragies massives incontrôlables autrement, en raison de ses risques propres.", { difficulty: "difficile" }),
  q("secours", "Sur les lieux d'un accident, avant de porter secours à une victime, quelle est la toute première action à effectuer selon la méthode de base des premiers secours (protéger, alerter, secourir) ?", [
    { text: "Sécuriser la zone (signalisation, mise à l'abri) pour éviter un suraccident", correct: true },
    { text: "Déplacer immédiatement la victime hors de la route, quel que soit son état", correct: false },
    { text: "Appeler directement les secours sans se préoccuper de la sécurité de la zone", correct: false },
    { text: "Prendre des photos de la scène pour le constat avant toute autre action", correct: false },
  ], "La méthode « protéger, alerter, secourir » impose de sécuriser la zone en premier lieu (signalisation, mise à l'abri des personnes) afin d'éviter un suraccident, avant même d'alerter les secours ou d'intervenir directement.", { difficulty: "difficile" }),
  q("secours", "Déplacer une victime consciente et sans signe de détresse vitale immédiatement après un accident est-il recommandé, en l'absence de danger immédiat (incendie, sur-accident) ?", [
    { text: "Non, il est préférable de ne pas la mobiliser inutilement, notamment en cas de suspicion de traumatisme du dos ou du cou", correct: true },
    { text: "Oui, il faut systématiquement l'éloigner du véhicule accidenté par précaution", correct: false },
    { text: "Oui, mais uniquement si elle se plaint de douleurs", correct: false },
    { text: "Cela n'a aucune importance tant que la victime reste consciente", correct: false },
  ], "En l'absence de danger immédiat, mobiliser une victime accidentée peut aggraver une éventuelle lésion de la colonne vertébrale non détectée : il est recommandé de ne pas la déplacer et d'attendre les secours qualifiés, sauf danger vital immédiat.", { difficulty: "difficile" }),
  q("secours", "Un défibrillateur automatisé externe (DAE) peut-il être utilisé par un simple témoin sans formation médicale ?", [
    { text: "Oui, l'appareil guide vocalement l'utilisateur et n'administre un choc que s'il le détecte nécessaire", correct: true },
    { text: "Non, seul un professionnel de santé habilité peut légalement l'utiliser", correct: false },
    { text: "Non, son usage est réservé aux pompiers et personnels du SAMU", correct: false },
    { text: "Oui, mais uniquement après autorisation téléphonique expresse d'un médecin régulateur", correct: false },
  ], "Les défibrillateurs automatisés externes sont conçus pour être utilisés par toute personne, formée ou non : l'appareil analyse le rythme cardiaque et ne délivre un choc électrique que s'il détecte une anomalie qui le justifie, guidant l'utilisateur vocalement.", { difficulty: "difficile" }),
  q("secours", "Quelle est la conduite à tenir face à une personne victime d'un étouffement complet (obstruction totale des voies aériennes) qui ne peut ni parler ni tousser ?", [
    { text: "Réaliser des claques dans le dos, puis si nécessaire la manœuvre de Heimlich (compressions abdominales)", correct: true },
    { text: "Lui faire boire immédiatement un grand verre d'eau pour dégager les voies", correct: false },
    { text: "La laisser tousser seule sans intervenir, le corps évacuant naturellement l'obstruction", correct: false },
    { text: "Pratiquer directement un massage cardiaque avant toute autre tentative", correct: false },
  ], "Face à une obstruction complète des voies aériennes, la méthode recommandée est d'abord les claques dans le dos, puis, en cas d'échec, la manœuvre de Heimlich (compressions abdominales) pour tenter d'expulser le corps étranger.", { difficulty: "difficile" }),
  q("mecanique", "Quelle est la profondeur minimale légale des sculptures d'un pneu de voiture particulière, en dessous de laquelle il est considéré comme lisse ?", [
    { text: "1,6 mm", correct: true },
    { text: "3 mm", correct: false },
    { text: "0,8 mm", correct: false },
    { text: "2,5 mm", correct: false },
  ], "L'article R314-1 du Code de la route fixe à 1,6 mm la profondeur minimale des sculptures dans les rainures principales d'un pneu de voiture particulière, mesurée grâce aux témoins d'usure (TWI) intégrés au pneu.", { difficulty: "difficile" }),
  q("mecanique", "Rouler avec des pneus dont la profondeur de sculpture est inférieure au minimum légal expose le conducteur à :", [
    { text: "Une amende forfaitaire de 135 € sans retrait de points, et une possible immobilisation du véhicule", correct: true },
    { text: "Une amende de 135 € et un retrait de 3 points, comme pour la ceinture de sécurité", correct: false },
    { text: "Aucune sanction tant que le contrôle technique n'a pas signalé le défaut", correct: false },
    { text: "Un simple avertissement lors du premier contrôle, sans amende", correct: false },
  ], "L'article R314-1 sanctionne les pneumatiques défectueux (usure excessive, déchirures, toile apparente) par une amende de 4e classe (135 €), sans retrait de points, avec une possible immobilisation du véhicule si le danger est jugé important.", { difficulty: "difficile" }),
  q("mecanique", "Au contrôle technique, des pneus usés sous le seuil légal de 1,6 mm entraînent :", [
    { text: "Une défaillance majeure imposant une contre-visite obligatoire dans un délai fixé", correct: true },
    { text: "Un simple avis consultatif sans obligation de contre-visite", correct: false },
    { text: "Le retrait immédiat de la carte grise du véhicule", correct: false },
    { text: "Une défaillance mineure sans conséquence sur la validité du contrôle", correct: false },
  ], "Une usure des pneus sous 1,6 mm constitue une défaillance majeure au contrôle technique, imposant une contre-visite dans un délai de deux mois, le véhicule ne pouvant continuer à circuler normalement sans remise en conformité.", { difficulty: "difficile" }),
  q("mecanique", "Un pneu présentant une hernie ou une déformation visible sur le flanc est-il considéré comme conforme, même si sa profondeur de sculpture est supérieure à 1,6 mm ?", [
    { text: "Non, une hernie constitue un défaut structurel du pneu, indépendant de l'usure de la bande de roulement", correct: true },
    { text: "Oui, seule la profondeur de sculpture est prise en compte par la réglementation", correct: false },
    { text: "Non, mais uniquement si la hernie dépasse 5 centimètres de diamètre", correct: false },
    { text: "Oui, tant que le pneu conserve sa pression nominale", correct: false },
  ], "L'article R314-1 exige aussi l'absence de déchirure profonde ou de toile apparente sur les flancs : une hernie, signe d'un défaut structurel dangereux (risque d'éclatement), rend le pneu non conforme même si la sculpture reste suffisante.", { difficulty: "difficile" }),
  q("mecanique", "Pour un véhicule particulier immatriculé pour la première fois, à quelle échéance le premier contrôle technique périodique doit-il être réalisé ?", [
    { text: "Dans les 6 mois précédant le 4e anniversaire de la première mise en circulation", correct: true },
    { text: "Dans l'année suivant la première immatriculation, quel que soit l'âge du véhicule", correct: false },
    { text: "Uniquement lors de la revente du véhicule, sans échéance fixe", correct: false },
    { text: "Dans les 6 mois précédant le 2e anniversaire de mise en circulation", correct: false },
  ], "Le premier contrôle technique périodique d'un véhicule léger doit être réalisé dans les 6 mois précédant son 4e anniversaire de première mise en circulation, puis renouvelé tous les 2 ans ensuite.", { difficulty: "difficile" }),
  q("mecanique", "Un avertisseur sonore (klaxon) est-il obligatoire sur tout véhicule à moteur en circulation en France ?", [
    { text: "Oui, tout véhicule à moteur doit être équipé d'un avertisseur sonore en état de fonctionnement", correct: true },
    { text: "Non, il s'agit d'un équipement facultatif laissé au choix du conducteur", correct: false },
    { text: "Oui, mais uniquement pour les véhicules circulant hors agglomération", correct: false },
    { text: "Non, seuls les véhicules de plus de 10 places sont concernés par cette obligation", correct: false },
  ], "L'avertisseur sonore fait partie des équipements obligatoires vérifiés au contrôle technique : tout véhicule à moteur doit en être équipé et il doit être fonctionnel, son usage étant néanmoins réglementé (interdiction en agglomération sauf danger immédiat).", { difficulty: "difficile" }),
  q("mecanique", "L'usage du klaxon (avertisseur sonore) en agglomération est-il autorisé en toutes circonstances ?", [
    { text: "Non, il n'est autorisé qu'en cas de danger immédiat, hors agglomération son usage étant plus largement toléré", correct: true },
    { text: "Oui, sans aucune restriction, à toute heure du jour et de la nuit", correct: false },
    { text: "Non, il est totalement interdit en agglomération, même en cas de danger", correct: false },
    { text: "Oui, mais uniquement entre 8h et 20h", correct: false },
  ], "En agglomération, l'usage de l'avertisseur sonore est réservé aux seuls cas de danger immédiat ; hors agglomération, il peut être utilisé de façon plus large pour signaler sa présence, notamment avant un dépassement.", { difficulty: "difficile" }),
  q("mecanique", "Une contre-visite après un contrôle technique défavorable doit être réalisée dans quel délai maximal ?", [
    { text: "2 mois à compter du contrôle initial", correct: true },
    { text: "6 mois à compter du contrôle initial", correct: false },
    { text: "15 jours à compter du contrôle initial", correct: false },
    { text: "1 an, comme pour le contrôle périodique classique", correct: false },
  ], "En cas de défaillance majeure constatée lors du contrôle technique, le véhicule dispose d'un délai de 2 mois pour être présenté à une contre-visite après réparation des défauts signalés.", { difficulty: "difficile" }),
  q("mecanique", "Une défaillance dite « critique » lors d'un contrôle technique (par exemple des freins gravement défectueux) a pour conséquence :", [
    { text: "Une immobilisation possible du véhicule dès le jour du contrôle, sans délai pour circuler", correct: true },
    { text: "Un délai de deux mois pour circuler normalement avant la contre-visite, comme une défaillance majeure", correct: false },
    { text: "Aucune conséquence immédiate, seule une note est ajoutée au rapport", correct: false },
    { text: "Une amende automatique de 135 € appliquée directement par le centre de contrôle", correct: false },
  ], "Contrairement à une défaillance majeure qui laisse un délai de 2 mois avant contre-visite, une défaillance critique (danger immédiat, notamment sur le système de freinage) peut justifier une restriction de circulation dès le jour même du contrôle.", { difficulty: "difficile" }),
  q("mecanique", "Les plaquettes de frein avant s'usent-elles généralement plus vite que les plaquettes arrière sur un véhicule à traction avant ?", [
    { text: "Oui, car le freinage sollicite davantage l'essieu avant qui supporte un report de charge lors du freinage", correct: true },
    { text: "Non, l'usure est strictement identique sur les quatre roues", correct: false },
    { text: "Non, les plaquettes arrière s'usent plus vite car elles freinent en dernier", correct: false },
    { text: "Cela dépend uniquement de la marque du véhicule, sans logique mécanique générale", correct: false },
  ], "Lors du freinage, le transfert de masse vers l'avant du véhicule augmente la charge sur les roues avant, qui fournissent donc l'essentiel de l'effort de freinage : les plaquettes avant s'usent en conséquence plus rapidement que les arrière.", { difficulty: "difficile" }),
  q("mecanique", "Les rétroviseurs extérieurs sont-ils un équipement obligatoire vérifié au contrôle technique ?", [
    { text: "Oui, leur présence, leur fixation et leur état sont contrôlés, tout comme le rétroviseur intérieur", correct: true },
    { text: "Non, seul le rétroviseur intérieur est vérifié au contrôle technique", correct: false },
    { text: "Non, les rétroviseurs ne font l'objet d'aucune vérification réglementaire", correct: false },
    { text: "Oui, mais uniquement sur les véhicules utilitaires", correct: false },
  ], "Le contrôle technique vérifie la présence, la fixation et le bon état des rétroviseurs extérieurs et intérieur, éléments essentiels de la visibilité du conducteur et donc de la sécurité routière.", { difficulty: "difficile" }),
  q("mecanique", "L'insertion de clous ou d'éléments métalliques dans les sculptures d'un pneu (pneus cloutés) est-elle autorisée toute l'année en France ?", [
    { text: "Non, elle n'est autorisée que pendant une période hivernale définie et dans certaines zones, sauf exceptions", correct: true },
    { text: "Oui, sans restriction de période ni de zone géographique", correct: false },
    { text: "Non, elle est totalement interdite en toutes circonstances en France", correct: false },
    { text: "Oui, mais uniquement sur les véhicules à quatre roues motrices", correct: false },
  ], "L'article R314-3 encadre strictement l'usage des pneus cloutés, autorisé uniquement durant une période hivernale définie chaque année par arrêté et sur certaines zones, en dehors desquelles leur usage est interdit.", { difficulty: "difficile" }),
  q("mecanique", "Le liquide de frein doit-il être remplacé périodiquement même s'il n'a jamais atteint le niveau minimal du réservoir ?", [
    { text: "Oui, car il absorbe l'humidité au fil du temps, ce qui abaisse sa température d'ébullition et réduit l'efficacité du freinage", correct: true },
    { text: "Non, tant que le niveau reste correct, aucun remplacement n'est nécessaire", correct: false },
    { text: "Non, le liquide de frein ne se dégrade jamais avec le temps", correct: false },
    { text: "Oui, mais uniquement tous les 10 ans, indépendamment du kilométrage", correct: false },
  ], "Le liquide de frein est hygroscopique : il absorbe progressivement l'humidité de l'air, ce qui abaisse son point d'ébullition et peut provoquer une perte d'efficacité du freinage (effet vapor-lock), d'où une préconisation de remplacement périodique (généralement tous les 2 ans).", { difficulty: "difficile" }),
  q("mecanique", "Les feux de croisement doivent-ils être allumés de jour dans certaines circonstances prévues par le Code de la route, indépendamment de tout équipement automatique ?", [
    { text: "Oui, notamment en cas de visibilité insuffisante liée aux conditions atmosphériques (brouillard, forte pluie)", correct: true },
    { text: "Non, l'allumage de jour reste toujours facultatif quelle que soit la météo", correct: false },
    { text: "Oui, mais uniquement pour les véhicules de plus de 10 ans", correct: false },
    { text: "Non, seuls les feux de jour à LED intégrés dispensent de toute obligation", correct: false },
  ], "Au-delà des feux de jour automatiques présents sur les véhicules récents, le Code de la route impose l'allumage des feux de croisement dès que les conditions de visibilité l'exigent, même en plein jour (brouillard, pluie intense, tunnel).", { difficulty: "difficile" }),
  q("mecanique", "Une roue de secours de type « galette » (temporaire) impose-t-elle une limitation de vitesse spécifique ?", [
    { text: "Oui, généralement 80 km/h maximum, selon les préconisations du constructeur", correct: true },
    { text: "Non, elle peut être utilisée sans aucune restriction de vitesse", correct: false },
    { text: "Oui, mais uniquement 50 km/h, comme en cas de brouillard", correct: false },
    { text: "Non, seule la distance parcourue est limitée, pas la vitesse", correct: false },
  ], "Une roue de secours temporaire (galette), plus étroite et non conçue pour un usage prolongé, impose généralement une limitation de vitesse à 80 km/h ainsi qu'une distance d'utilisation limitée, précisées par le constructeur.", { difficulty: "difficile" }),
  q("mecanique", "Le remplacement d'une courroie de distribution non respecté au-delà de l'intervalle préconisé par le constructeur expose principalement à quel risque mécanique majeur ?", [
    { text: "La casse du moteur en cas de rupture de la courroie, potentiellement irréversible sur un moteur à soupapes non protégées", correct: true },
    { text: "Une simple perte de puissance progressive sans risque de casse", correct: false },
    { text: "Un risque uniquement électrique, sans lien avec le moteur", correct: false },
    { text: "Une usure accélérée des pneus uniquement", correct: false },
  ], "Sur un moteur dit « non protégé », la rupture de la courroie de distribution provoque une collision entre pistons et soupapes, entraînant généralement une casse moteur majeure et coûteuse — d'où l'importance de respecter l'intervalle de remplacement préconisé.", { difficulty: "difficile" }),
  q("environnement", "Depuis le 1er janvier 2025, quelles catégories de véhicules Crit'Air sont concernées par les restrictions de circulation dans la majorité des ZFE françaises ?", [
    { text: "Les véhicules classés Crit'Air 3, 4, 5 et les véhicules non classés", correct: true },
    { text: "Uniquement les véhicules Crit'Air 5 et non classés", correct: false },
    { text: "Tous les véhicules, y compris Crit'Air 0 et 1, selon un calendrier tournant", correct: false },
    { text: "Uniquement les véhicules diesel, indépendamment de leur vignette Crit'Air", correct: false },
  ], "Depuis le 1er janvier 2025, les véhicules classés Crit'Air 3, 4, 5 ainsi que les véhicules non classés sont visés par les restrictions de circulation dans la plupart des zones à faibles émissions (ZFE) déployées en France.", { difficulty: "difficile" }),
  q("environnement", "En cas de non-respect des restrictions de circulation dans une ZFE avec un véhicule léger non autorisé, quelle amende est généralement prévue ?", [
    { text: "68 €", correct: true },
    { text: "135 €, comme pour un poids lourd", correct: false },
    { text: "35 €, comme un stationnement gênant", correct: false },
    { text: "750 €, montant maximal d'une contravention de 4e classe", correct: false },
  ], "L'amende forfaitaire pour circulation d'un véhicule léger non conforme dans une ZFE est de 68 €, contre 135 € pour un poids lourd, sans retrait de points sur le permis de conduire.", { difficulty: "difficile" }),
  q("environnement", "Quel est le prix officiel de la vignette Crit'Air, quelle que soit la classe environnementale du véhicule ?", [
    { text: "Un tarif unique d'environ 3 à 4 €, frais d'envoi inclus", correct: true },
    { text: "Un tarif variable selon la classe Crit'Air, de 5 € à 50 €", correct: false },
    { text: "Gratuite pour tous les véhicules depuis 2024", correct: false },
    { text: "Un tarif proportionnel à la puissance fiscale du véhicule", correct: false },
  ], "La vignette Crit'Air est délivrée au tarif unique d'environ 3 à 4 € frais de port inclus, quelle que soit la classe environnementale attribuée au véhicule (de Crit'Air 0 à Crit'Air 5).", { difficulty: "difficile" }),
  q("environnement", "L'éco-conduite recommande d'anticiper les ralentissements pour lever le pied plutôt que de freiner tardivement. Quel est le principal bénéfice environnemental de cette pratique ?", [
    { text: "Elle permet une décélération en roue libre ou en frein moteur, réduisant la consommation de carburant sans perte d'énergie utile par le freinage", correct: true },
    { text: "Elle n'a aucun effet mesurable sur la consommation, seul l'entretien du véhicule comptant réellement", correct: false },
    { text: "Elle réduit uniquement l'usure des pneus, sans lien avec la consommation de carburant", correct: false },
    { text: "Elle n'améliore que le confort des passagers, sans bénéfice environnemental", correct: false },
  ], "En anticipant un ralentissement, le conducteur peut relâcher l'accélérateur suffisamment tôt pour laisser le véhicule décélérer naturellement (roue libre ou frein moteur) plutôt que de dissiper l'énergie cinétique en chaleur par un freinage tardif, ce qui réduit la consommation de carburant.", { difficulty: "difficile" }),
  q("environnement", "Une conduite à régime moteur élevé et des accélérations brusques augmentent la consommation de carburant de combien, en moyenne, par rapport à une conduite souple, selon les estimations de l'ADEME ?", [
    { text: "Jusqu'à 40 % de surconsommation dans certains cas de conduite très agressive", correct: true },
    { text: "Moins de 5 %, l'effet étant marginal", correct: false },
    { text: "La consommation n'est pas affectée par le style de conduite, seul le poids du véhicule comptant", correct: false },
    { text: "Exactement 10 %, quel que soit le type de trajet", correct: false },
  ], "Selon les estimations de l'ADEME, une conduite agressive (accélérations brusques, régimes moteur élevés, freinages tardifs) peut entraîner une surconsommation de carburant pouvant atteindre 40 % par rapport à une conduite souple et anticipative.", { difficulty: "difficile" }),
  q("environnement", "Le Conseil constitutionnel a censuré la suppression des ZFE le 21 mai 2026. Sur quel motif juridique cette censure repose-t-elle principalement ?", [
    { text: "Un « cavalier législatif » : la mesure n'avait pas de lien suffisant avec le texte de loi dans lequel elle avait été insérée", correct: true },
    { text: "Une atteinte directe au principe constitutionnel de protection de l'environnement", correct: false },
    { text: "Un vice de forme lié à l'absence de vote du Sénat sur cette disposition", correct: false },
    { text: "Une contradiction avec le droit européen sur la qualité de l'air", correct: false },
  ], "La suppression des ZFE avait été ajoutée par amendement à un texte de simplification de la vie économique. Le Conseil constitutionnel a jugé ce lien insuffisant (cavalier législatif), motif purement procédural qui a entraîné la censure sans se prononcer sur le fond.", { difficulty: "difficile" }),
  q("environnement", "Le contrôle technique intègre-t-il une mesure des émissions polluantes pour les véhicules essence et diesel ?", [
    { text: "Oui, un contrôle de la pollution (opacité des fumées pour le diesel, taux de CO pour l'essence) fait partie des points vérifiés", correct: true },
    { text: "Non, seule la sécurité mécanique est vérifiée, sans aucun contrôle environnemental", correct: false },
    { text: "Oui, mais uniquement pour les véhicules diesel, l'essence étant exemptée", correct: false },
    { text: "Non, ce contrôle n'existe que pour les véhicules utilitaires professionnels", correct: false },
  ], "Le contrôle technique comprend un volet pollution : mesure de l'opacité des fumées pour les moteurs diesel et du taux de monoxyde de carbone pour les moteurs essence, avec des seuils réglementaires à ne pas dépasser sous peine de contre-visite.", { difficulty: "difficile" }),
  q("environnement", "Le fait de couper le moteur lors d'un arrêt prolongé (plus de quelques dizaines de secondes) plutôt que de le laisser tourner au ralenti a pour effet principal :", [
    { text: "De réduire la consommation de carburant et les émissions polluantes locales, notamment en zone urbaine dense", correct: true },
    { text: "D'user prématurément le moteur à chaque redémarrage, rendant la pratique globalement négative", correct: false },
    { text: "De n'avoir aucun impact mesurable sur la consommation, contrairement aux idées reçues", correct: false },
    { text: "De réduire uniquement le bruit, sans effet sur la consommation ou les émissions", correct: false },
  ], "Sur les moteurs modernes, couper le moteur lors d'un arrêt de plus de quelques dizaines de secondes réduit la consommation de carburant et les émissions polluantes locales ; c'est le principe des systèmes « stop and start » généralisés sur les véhicules récents.", { difficulty: "difficile" }),
  q("environnement", "Un pneu sous-gonflé par rapport à la pression préconisée par le constructeur a quel impact principal sur la consommation de carburant ?", [
    { text: "Il l'augmente, en raison d'une résistance au roulement accrue", correct: true },
    { text: "Il la diminue légèrement, en augmentant la surface de contact au sol", correct: false },
    { text: "Il n'a aucun impact mesurable sur la consommation de carburant", correct: false },
    { text: "Il ne modifie que la tenue de route, sans lien avec la consommation", correct: false },
  ], "Un pneu sous-gonflé augmente la résistance au roulement, ce qui accroît l'effort du moteur pour maintenir la même vitesse et donc la consommation de carburant, tout en accélérant l'usure du pneu et en dégradant la tenue de route.", { difficulty: "difficile" }),
  q("environnement", "Le covoiturage régulier pour les trajets domicile-travail peut-il donner droit à une aide financière incitative de l'État ou des collectivités ?", [
    { text: "Oui, une prime au covoiturage peut être versée aux conducteurs pour les premiers trajets effectués via une application labellisée", correct: true },
    { text: "Non, aucun dispositif d'aide n'existe en France pour le covoiturage", correct: false },
    { text: "Oui, mais uniquement pour les trajets de plus de 200 km", correct: false },
    { text: "Non, seule la voiture électrique bénéficie d'aides financières", correct: false },
  ], "Un dispositif de prime au covoiturage existe en France, versé par les plateformes labellisées aux conducteurs qui réalisent leurs premiers trajets de covoiturage, dans le cadre des politiques de réduction des émissions liées aux déplacements domicile-travail.", { difficulty: "difficile" }),
  q("environnement", "Le malus écologique applicable à l'achat d'un véhicule neuf est-il calculé en fonction de sa consommation de carburant ou de ses émissions de CO2 ?", [
    { text: "De ses émissions de CO2 par kilomètre, mesurées selon le cycle d'homologation en vigueur", correct: true },
    { text: "De sa consommation de carburant exprimée en litres aux 100 km", correct: false },
    { text: "Uniquement de son poids, sans lien avec les émissions", correct: false },
    { text: "De sa puissance fiscale exprimée en chevaux uniquement", correct: false },
  ], "Le malus écologique est calculé sur la base des émissions de CO2 par kilomètre du véhicule, mesurées selon le cycle d'homologation (WLTP), au-delà d'un seuil révisé chaque année à la baisse.", { difficulty: "difficile" }),
  q("environnement", "Une conduite en éco-conduite recommande de rétrograder tardivement ou d'anticiper les changements de rapport. Quel principe guide cette recommandation sur une boîte manuelle ?", [
    { text: "Rouler au régime moteur le plus bas possible compatible avec la vitesse, pour limiter la consommation", correct: true },
    { text: "Rouler systématiquement à haut régime pour optimiser la puissance disponible en cas d'urgence", correct: false },
    { text: "Le choix du rapport de vitesse n'a aucune influence sur la consommation de carburant", correct: false },
    { text: "Rétrograder le plus tôt possible avant chaque virage, indépendamment de la vitesse", correct: false },
  ], "L'éco-conduite préconise de passer les rapports supérieurs dès que possible et de rouler au régime moteur le plus bas compatible avec une conduite souple, le moteur consommant proportionnellement moins de carburant à bas régime pour une même vitesse.", { difficulty: "difficile" }),
  q("environnement", "La climatisation d'un véhicule a-t-elle un impact significatif sur la consommation de carburant, notamment en usage urbain à faible vitesse ?", [
    { text: "Oui, elle peut augmenter la consommation de façon notable, l'effet étant proportionnellement plus marqué à faible vitesse", correct: true },
    { text: "Non, la climatisation moderne n'a plus aucun impact sur la consommation", correct: false },
    { text: "Oui, mais uniquement sur autoroute à haute vitesse", correct: false },
    { text: "Non, seul le chauffage a un impact sur la consommation, pas la climatisation", correct: false },
  ], "La climatisation sollicite le moteur (via le compresseur) et augmente la consommation de carburant ; cet effet est proportionnellement plus marqué en usage urbain à faible vitesse, où la consommation de base est déjà faible.", { difficulty: "difficile" }),
  q("environnement", "Le rétrofit électrique, qui consiste à convertir un véhicule thermique en véhicule électrique, est-il encadré et autorisé en France ?", [
    { text: "Oui, depuis 2020, un cadre réglementaire permet l'homologation de kits de rétrofit électrique sous certaines conditions", correct: true },
    { text: "Non, cette pratique reste totalement interdite en France", correct: false },
    { text: "Oui, mais uniquement pour les véhicules de collection de plus de 30 ans", correct: false },
    { text: "Non, seuls les professionnels peuvent bénéficier de cette conversion, jamais les particuliers", correct: false },
  ], "Depuis un décret de 2020, le rétrofit électrique est encadré juridiquement en France : des kits homologués permettent de convertir un véhicule thermique en véhicule électrique, avec mise à jour de la carte grise, sous réserve du respect de normes techniques strictes.", { difficulty: "difficile" }),
  q("environnement", "Le leasing social, dispositif visant à faciliter l'accès à un véhicule électrique pour les ménages modestes, cible principalement quel objectif de politique environnementale ?", [
    { text: "Accélérer le renouvellement du parc automobile vers des véhicules moins polluants, notamment pour les personnes concernées par les restrictions ZFE", correct: true },
    { text: "Financer exclusivement l'achat de véhicules thermiques récents", correct: false },
    { text: "Subventionner uniquement les deux-roues motorisés électriques", correct: false },
    { text: "Remplacer intégralement le dispositif du bonus écologique classique pour tous les acheteurs", correct: false },
  ], "Le leasing social vise à rendre accessible la location d'un véhicule électrique à un coût réduit pour les ménages aux revenus modestes, notamment ceux résidant dans ou à proximité d'une ZFE et concernés par les restrictions de circulation des véhicules polluants.", { difficulty: "difficile" }),
  q("environnement", "Une accélération progressive plutôt que brutale au démarrage réduit-elle uniquement la consommation, ou a-t-elle un autre effet notable sur le véhicule ?", [
    { text: "Elle réduit aussi l'usure mécanique (transmission, pneus, embrayage) en plus de la consommation de carburant", correct: true },
    { text: "Elle n'a aucun effet autre que la consommation de carburant", correct: false },
    { text: "Elle augmente l'usure des freins de façon disproportionnée", correct: false },
    { text: "Elle n'affecte que le confort sonore, sans lien mécanique", correct: false },
  ], "Une accélération progressive limite les contraintes mécaniques sur la transmission, l'embrayage et les pneus (moins de patinage), ce qui réduit à la fois la consommation de carburant et l'usure prématurée de ces composants.", { difficulty: "difficile" }),
  q("securite", "Le non-port de la ceinture de sécurité par le conducteur est sanctionné par :", [
    { text: "135 € d'amende et un retrait de 3 points sur le permis", correct: true },
    { text: "35 € d'amende sans retrait de points", correct: false },
    { text: "135 € d'amende sans aucun retrait de points", correct: false },
    { text: "750 € d'amende automatique, sans possibilité de minoration", correct: false },
  ], "L'article R412-1 sanctionne le non-port de la ceinture de sécurité par une contravention de 4e classe : 135 € d'amende forfaitaire (pouvant atteindre 750 € en cas de contestation rejetée) et un retrait de 3 points sur le permis du conducteur.", { difficulty: "difficile" }),
  q("securite", "Un enfant de moins de 10 ans doit-il obligatoirement être installé dans un système de retenue homologué (siège auto, réhausseur), sans exception ?", [
    { text: "En principe oui, sauf exceptions prévues par la loi : morphologie adaptée à la ceinture, certificat médical d'exemption, ou transport en taxi", correct: true },
    { text: "Non, la ceinture de sécurité classique suffit dès l'âge de 6 ans dans tous les cas", correct: false },
    { text: "Oui, absolument sans aucune exception possible, quel que soit le contexte", correct: false },
    { text: "Non, cette obligation ne s'applique qu'aux trajets de plus de 50 km", correct: false },
  ], "L'article R412-2 impose un système de retenue homologué pour tout enfant de moins de 10 ans, avec des exceptions limitées : morphologie rendant la ceinture adaptée, certificat médical d'exemption, ou transport dans un taxi ou un véhicule de transport en commun.", { difficulty: "difficile" }),
  q("securite", "Dans un véhicule dont un siège n'est pas équipé de ceinture de sécurité, un enfant de moins de 3 ans peut-il y être transporté ?", [
    { text: "Non, il est formellement interdit de transporter un enfant de moins de 3 ans sur un siège dépourvu de ceinture de sécurité", correct: true },
    { text: "Oui, à condition d'être tenu fermement par un adulte assis à ses côtés", correct: false },
    { text: "Oui, sans restriction particulière, la présence d'un adulte suffisant", correct: false },
    { text: "Non, cette interdiction ne concerne que les enfants de moins d'un an", correct: false },
  ], "Le Code de la route interdit formellement de transporter un enfant de moins de 3 ans sur un siège non équipé de ceinture de sécurité, quelle que soit la présence d'un adulte à proximité.", { difficulty: "difficile" }),
  q("securite", "Un stationnement qualifié de « dangereux » (article R417-9), par exemple juste après un virage sans visibilité, est-il sanctionné de la même façon qu'un stationnement gênant classique ?", [
    { text: "Non, il est plus sévèrement sanctionné : 135 € d'amende et un retrait de 3 points, contrairement au stationnement gênant qui ne retire aucun point", correct: true },
    { text: "Oui, la sanction est strictement identique dans les deux cas : 35 € sans retrait de points", correct: false },
    { text: "Non, il est moins sanctionné, car considéré comme une simple gêne temporaire", correct: false },
    { text: "Oui, les deux infractions entraînent systématiquement la mise en fourrière", correct: false },
  ], "Contrairement au stationnement gênant (35 €, sans point) ou très gênant (135 €, sans point), le stationnement dangereux au sens de l'article R417-9 constitue une mise en danger caractérisée et entraîne un retrait de 3 points en plus de l'amende de 135 €.", { difficulty: "difficile" }),
  q("securite", "Le chargement d'un véhicule dépassant l'aplomb arrière doit être signalé par un dispositif spécifique dès quel dépassement ?", [
    { text: "Dès que le chargement dépasse d'un mètre l'aplomb arrière du véhicule, un panneau ou dispositif de signalisation devient obligatoire", correct: true },
    { text: "Dès le moindre centimètre de dépassement, sans aucune tolérance", correct: false },
    { text: "Uniquement au-delà de 3 mètres de dépassement", correct: false },
    { text: "Aucune signalisation n'est jamais exigée quel que soit le dépassement", correct: false },
  ], "Lorsqu'un chargement dépasse d'un mètre ou plus l'aplomb arrière du véhicule, la réglementation impose la pose d'un dispositif de signalisation (panneau, flamme ou dispositif réfléchissant) pour avertir les autres usagers.", { difficulty: "difficile" }),
  q("securite", "Un conducteur transporte une charge non arrimée qui se détache et cause un accident. Sa responsabilité pénale peut-elle être engagée même sans intention de nuire ?", [
    { text: "Oui, un défaut d'arrimage causant un dommage à autrui peut engager la responsabilité pénale du conducteur pour blessures ou homicide involontaires", correct: true },
    { text: "Non, seule une intention de nuire clairement établie permettrait d'engager sa responsabilité pénale", correct: false },
    { text: "Non, seule une responsabilité civile (indemnisation) peut être recherchée, jamais pénale", correct: false },
    { text: "Oui, mais uniquement si le véhicule est un poids lourd professionnel", correct: false },
  ], "Un défaut d'arrimage relève de la négligence ou de l'imprudence : s'il cause un accident corporel, la responsabilité pénale du conducteur peut être engagée pour blessures ou homicide involontaires, indépendamment de toute intention de nuire.", { difficulty: "difficile" }),
  q("securite", "Le port du gilet de haute visibilité est-il obligatoire uniquement en cas de panne, ou également dans d'autres circonstances prévues par le Code de la route ?", [
    { text: "Il est obligatoire dès que le conducteur ou un passager doit sortir du véhicule immobilisé sur la chaussée ou ses abords de nuit ou par visibilité insuffisante", correct: true },
    { text: "Il n'est obligatoire qu'en cas de panne sur autoroute, jamais sur route ordinaire", correct: false },
    { text: "Il n'est jamais obligatoire, seul le triangle de signalisation l'étant", correct: false },
    { text: "Il est obligatoire uniquement pour le conducteur, jamais pour les passagers", correct: false },
  ], "Le gilet haute visibilité doit être porté par toute personne circulant à pied sur la chaussée ou ses abords, de nuit ou par visibilité insuffisante, en cas d'immobilisation du véhicule (panne, accident), et pas uniquement lors des pannes sur autoroute.", { difficulty: "difficile" }),
  q("securite", "Le défaut de port de la ceinture de sécurité par un passager adulte de plus de 18 ans engage-t-il la responsabilité (amende, points) du conducteur ou celle du passager lui-même ?", [
    { text: "Celle du passager lui-même, qui est directement sanctionné en tant qu'auteur de l'infraction", correct: true },
    { text: "Celle du conducteur uniquement, quel que soit l'âge du passager", correct: false },
    { text: "Les deux sont sanctionnés à parts égales dans tous les cas", correct: false },
    { text: "Aucun des deux n'est sanctionné si le passager est assis à l'arrière du véhicule", correct: false },
  ], "Pour un passager majeur, c'est lui-même qui est sanctionné en cas de non-port de la ceinture. En revanche, si le passager non attaché a moins de 18 ans, c'est le conducteur qui devient responsable et encourt la sanction.", { difficulty: "difficile" }),
  q("securite", "Un siège auto pour enfant doit-il obligatoirement être installé dos à la route jusqu'à un certain âge ou une certaine taille ?", [
    { text: "Oui, la réglementation impose l'installation dos à la route au minimum jusqu'à ce que l'enfant atteigne l'âge ou le poids fixé par l'homologation du siège (généralement autour de 15 mois selon les normes actuelles)", correct: true },
    { text: "Non, l'installation face à la route est autorisée dès la naissance sans restriction", correct: false },
    { text: "Oui, mais uniquement jusqu'à l'âge de 3 mois", correct: false },
    { text: "Non, cette orientation est une simple recommandation sans valeur réglementaire", correct: false },
  ], "La réglementation impose, selon la norme d'homologation du siège utilisé, une installation dos à la route pendant une durée minimale (souvent jusqu'à environ 15 mois selon les normes i-Size les plus récentes), l'orientation dos à la route protégeant mieux la tête et la nuque de l'enfant en cas de choc frontal.", { difficulty: "difficile" }),
  q("securite", "Un triangle de présignalisation doit être placé à quelle distance minimale approximative du véhicule en panne, pour être efficace ?", [
    { text: "Environ 30 mètres, afin de laisser aux autres usagers le temps d'anticiper", correct: true },
    { text: "Environ 5 mètres, juste derrière le véhicule", correct: false },
    { text: "Environ 100 mètres, quelle que soit la configuration de la route", correct: false },
    { text: "La distance n'a aucune importance tant que le triangle est visible", correct: false },
  ], "Le triangle de présignalisation doit être placé à une distance suffisante (généralement autour de 30 mètres, davantage sur autoroute) pour permettre aux autres usagers d'anticiper la présence du véhicule immobilisé, en tenant compte de la visibilité et de la vitesse de la voie.", { difficulty: "difficile" }),
  q("securite", "Le fait de circuler avec un chargement qui masque partiellement les feux arrière ou la plaque d'immatriculation constitue-t-il une infraction distincte du défaut d'arrimage ?", [
    { text: "Oui, le masquage des feux ou de la plaque est une infraction spécifique, indépendante de la question de l'arrimage du chargement", correct: true },
    { text: "Non, il s'agit exactement de la même infraction que le défaut d'arrimage", correct: false },
    { text: "Non, aucune sanction n'est prévue tant que le chargement lui-même est bien arrimé", correct: false },
    { text: "Oui, mais uniquement si le masquage dépasse 50 % de la surface du feu", correct: false },
  ], "Le Code de la route sanctionne séparément le fait de circuler avec une plaque d'immatriculation ou des feux masqués, rendus illisibles ou peu visibles, qu'il s'agisse d'un défaut d'entretien ou d'un chargement mal positionné.", { difficulty: "difficile" }),
  q("securite", "Une remorque tractée par un véhicule léger doit-elle obligatoirement être équipée de feux de freinage et de clignotants fonctionnels ?", [
    { text: "Oui, dès lors que la remorque est attelée et circule sur la voie publique, ses feux doivent être fonctionnels et synchronisés avec ceux du véhicule tracteur", correct: true },
    { text: "Non, seuls les feux de position arrière sont obligatoires sur une remorque", correct: false },
    { text: "Non, l'obligation ne concerne que les remorques de plus de 750 kg", correct: false },
    { text: "Oui, mais uniquement pour une circulation de nuit", correct: false },
  ], "Toute remorque attelée à un véhicule doit être équipée de feux de position, de freinage et de clignotants fonctionnels, correctement synchronisés avec ceux du véhicule tracteur, quelle que soit sa charge et l'heure de circulation.", { difficulty: "difficile" }),
  q("securite", "Un conducteur transportant des animaux domestiques dans son véhicule doit veiller à ce que ceux-ci :", [
    { text: "Ne puissent pas gêner sa conduite ni compromettre la sécurité, un dispositif de retenue (cage, grille, harnais) étant recommandé voire exigé selon les cas", correct: true },
    { text: "Restent obligatoirement dans le coffre, quelle que soit la taille du véhicule", correct: false },
    { text: "N'aient aucune restriction particulière, le Code de la route ne concernant pas les animaux", correct: false },
    { text: "Soient systématiquement tenus en laisse par un passager pendant tout le trajet", correct: false },
  ], "Le Code de la route impose que rien ne puisse gêner les mouvements du conducteur ou compromettre la sécurité : un animal domestique doit donc être maintenu par un dispositif adapté (cage, grille de séparation, harnais de sécurité) pour éviter tout risque en cas de freinage ou d'accident.", { difficulty: "difficile" }),
  q("securite", "Le port du casque est-il obligatoire pour le conducteur et le passager d'un cyclomoteur ou d'une motocyclette, quelle que soit la cylindrée ?", [
    { text: "Oui, sans exception liée à la cylindrée, dès lors qu'il s'agit d'un deux-roues motorisé", correct: true },
    { text: "Non, uniquement au-delà de 125 cm3 de cylindrée", correct: false },
    { text: "Non, uniquement hors agglomération", correct: false },
    { text: "Oui, mais uniquement pour le conducteur, jamais pour le passager", correct: false },
  ], "Le port du casque homologué est obligatoire pour le conducteur et tout passager d'un deux-roues motorisé, quelle que soit la cylindrée du véhicule (y compris les cyclomoteurs de faible puissance) et le lieu de circulation.", { difficulty: "difficile" }),
  q("securite", "Une charge dépassant latéralement le gabarit du véhicule de plus de 20 centimètres de chaque côté nécessite-t-elle une signalisation ou une autorisation particulière ?", [
    { text: "Oui, un dépassement latéral significatif impose une signalisation spécifique, voire une autorisation de transport exceptionnel au-delà de certains seuils", correct: true },
    { text: "Non, aucun seuil de dépassement latéral n'est réglementé en France", correct: false },
    { text: "Oui, mais uniquement pour les véhicules agricoles", correct: false },
    { text: "Non, seul le dépassement à l'arrière du véhicule est réglementé", correct: false },
  ], "Le dépassement latéral d'un chargement au-delà des limites de gabarit autorisées impose une signalisation adaptée et, au-delà de certains seuils, une autorisation de transport exceptionnel délivrée par les autorités compétentes.", { difficulty: "difficile" }),
  q("securite", "Un airbag frontal déployé lors d'un choc peut-il être dangereux pour un enfant installé dans un siège auto orienté dos à la route à l'avant du véhicule ?", [
    { text: "Oui, c'est pourquoi il est formellement interdit d'installer un siège dos à la route sur un siège passager avant équipé d'un airbag actif non désactivé", correct: true },
    { text: "Non, l'airbag frontal ne présente aucun risque particulier pour un siège orienté dos à la route", correct: false },
    { text: "Oui, mais uniquement si l'enfant a plus de 2 ans", correct: false },
    { text: "Non, cette interdiction ne concerne que les airbags latéraux, jamais les airbags frontaux", correct: false },
  ], "Le déploiement d'un airbag frontal contre le dossier d'un siège auto dos à la route peut projeter violemment le siège et l'enfant : la réglementation interdit donc formellement cette configuration sauf désactivation certifiée de l'airbag passager.", { difficulty: "difficile" }),
  q("divers", "Quelle est la différence de sanction entre un stationnement « gênant » et un stationnement « très gênant » ?", [
    { text: "35 € pour le stationnement gênant contre 135 € pour le très gênant, sans retrait de points dans les deux cas", correct: true },
    { text: "135 € dans les deux cas, mais avec un retrait de 3 points uniquement pour le très gênant", correct: false },
    { text: "35 € pour les deux cas, la différence ne portant que sur la durée de stationnement", correct: false },
    { text: "Le stationnement très gênant entraîne systématiquement un retrait de 3 points, contrairement au gênant", correct: false },
  ], "Le stationnement gênant classique (article R417-10) est une contravention de 2e classe sanctionnée par 35 €, tandis que le stationnement très gênant (article R417-11, par exemple sur trottoir, piste cyclable ou passage piéton) est une contravention de 4e classe à 135 € — mais aucun des deux ne retire de points.", { difficulty: "difficile" }),
  q("divers", "Stationner sur une piste cyclable est-il qualifié de stationnement gênant ou très gênant, et quelle amende cela entraîne-t-il ?", [
    { text: "Très gênant, sanctionné par une amende forfaitaire de 135 €", correct: true },
    { text: "Gênant simple, sanctionné par une amende de 35 €", correct: false },
    { text: "Dangereux, avec un retrait de 3 points en plus de l'amende", correct: false },
    { text: "Aucune sanction spécifique, la piste cyclable n'étant pas mentionnée par le Code de la route", correct: false },
  ], "Depuis le décret du 2 juillet 2015, le stationnement sur une bande ou piste cyclable est qualifié de stationnement très gênant (article R417-11) et sanctionné par une amende forfaitaire de 135 €, sans retrait de points.", { difficulty: "difficile" }),
  q("divers", "Un stationnement gênant peut-il, dans certaines zones touristiques, être requalifié en stationnement « abusif » ?", [
    { text: "Oui, si le véhicule n'est pas déplacé dans les deux heures suivant le procès-verbal initial pour stationnement gênant", correct: true },
    { text: "Non, ces deux notions sont totalement indépendantes l'une de l'autre", correct: false },
    { text: "Oui, mais uniquement pour les véhicules de moins de 3,5 tonnes", correct: false },
    { text: "Non, la requalification n'existe que pour le stationnement dangereux", correct: false },
  ], "L'article R417-13 permet, dans les zones touristiques, de requalifier un stationnement gênant en stationnement abusif si le véhicule concerné (bus, camping-car, caravane, véhicule avec remorque) n'est pas déplacé dans les deux heures suivant la contravention initiale.", { difficulty: "difficile" }),
  q("divers", "Le délit de fuite, défini à l'article L231-1 du Code de la route et 434-10 du Code pénal, s'applique-t-il uniquement en cas d'accident corporel ?", [
    { text: "Non, il s'applique dès qu'un dommage matériel ou corporel, même léger, résulte de l'accident et que le conducteur tente d'échapper à sa responsabilité", correct: true },
    { text: "Oui, il ne concerne que les accidents ayant causé des blessures ou un décès", correct: false },
    { text: "Non, il s'applique même en l'absence de tout dommage, dès lors qu'un accident a eu lieu", correct: false },
    { text: "Oui, mais uniquement si un piéton est impliqué dans l'accident", correct: false },
  ], "Le délit de fuite est constitué dès qu'un dommage matériel ou corporel, même léger (par exemple heurter un véhicule stationné), résulte de l'accident et que le conducteur quitte les lieux pour échapper à sa responsabilité pénale ou civile.", { difficulty: "difficile" }),
  q("divers", "Quelle peine maximale encourt un conducteur reconnu coupable de délit de fuite, hors circonstances aggravantes liées à la gravité des blessures de la victime ?", [
    { text: "3 ans d'emprisonnement et 75 000 € d'amende", correct: true },
    { text: "1 an d'emprisonnement et 15 000 € d'amende", correct: false },
    { text: "5 ans d'emprisonnement et 100 000 € d'amende, peine identique à l'homicide routier", correct: false },
    { text: "Une simple amende de 3 750 €, sans peine de prison possible", correct: false },
  ], "L'article L231-1 du Code de la route, renvoyant à l'article 434-10 du Code pénal, punit le délit de fuite de 3 ans d'emprisonnement et 75 000 € d'amende ; ces peines peuvent être doublées en cas de blessures graves ou de décès de la victime.", { difficulty: "difficile" }),
  q("divers", "Le refus de remplir un constat amiable après un accrochage constitue-t-il, à lui seul, un délit de fuite ?", [
    { text: "Non, le constat amiable n'est pas obligatoire et son refus seul ne caractérise pas un délit de fuite, contrairement au fait de quitter les lieux sans se faire connaître", correct: true },
    { text: "Oui, tout refus de constat amiable est automatiquement assimilé à un délit de fuite", correct: false },
    { text: "Oui, mais uniquement si l'autre conducteur porte plainte dans les 24 heures", correct: false },
    { text: "Non, mais il entraîne systématiquement un retrait de 6 points", correct: false },
  ], "Remplir un constat amiable n'est pas une obligation légale : seul le fait de quitter les lieux d'un accident sans décliner son identité, en sachant avoir causé un dommage, caractérise le délit de fuite — pas le simple refus de constat.", { difficulty: "difficile" }),
  q("divers", "Conduire sans assurance (défaut d'assurance, article L324-2) entraîne-t-il un retrait de points sur le permis de conduire ?", [
    { text: "Non, ce délit n'entraîne aucun retrait de points, contrairement à la plupart des délits routiers", correct: true },
    { text: "Oui, un retrait de 6 points est systématiquement appliqué, comme pour l'alcool au volant", correct: false },
    { text: "Oui, mais seulement 3 points, comme pour le non-port de la ceinture", correct: false },
    { text: "Non, mais le permis est automatiquement annulé dès la première infraction", correct: false },
  ], "Contrairement à la plupart des délits routiers, le défaut d'assurance n'entraîne pas de retrait de points sur le permis, même s'il expose à une amende délictuelle pouvant atteindre 3 750 € et à des peines complémentaires comme la suspension du permis.", { difficulty: "difficile" }),
  q("divers", "Le montant de l'amende forfaitaire délictuelle applicable au premier constat de défaut d'assurance, en dehors de toute procédure judiciaire, est de :", [
    { text: "500 €, avec une version minorée à 400 € et majorée à 1 000 €", correct: true },
    { text: "3 750 €, montant unique quelle que soit la rapidité du paiement", correct: false },
    { text: "135 €, comme une contravention de 4e classe classique", correct: false },
    { text: "1 500 €, sans possibilité de minoration ou de majoration", correct: false },
  ], "L'article L324-2 prévoit une amende forfaitaire délictuelle de 500 € pour le défaut d'assurance, réductible à 400 € en cas de paiement rapide, ou majorée à 1 000 € en cas de retard — un montant très inférieur au plafond judiciaire de 3 750 € encouru en cas de poursuite classique ou de récidive.", { difficulty: "difficile" }),
  q("divers", "Sur autoroute, la bande d'arrêt d'urgence peut-elle être utilisée en tant que voie de circulation temporaire lors de certaines périodes de forte affluence ?", [
    { text: "Oui, certaines sections peuvent être ouvertes temporairement à la circulation lors de pics de trafic, sur décision et signalisation spécifique des autorités", correct: true },
    { text: "Non, la bande d'arrêt d'urgence ne peut jamais servir à la circulation, quelle que soit la situation", correct: false },
    { text: "Oui, mais uniquement pour les véhicules de transport en commun", correct: false },
    { text: "Non, sauf en cas d'accident bloquant totalement les voies de circulation normales", correct: false },
  ], "Dans certaines zones à fort trafic, des dispositifs de « voie dynamique » permettent d'ouvrir temporairement la bande d'arrêt d'urgence à la circulation lors de pics d'affluence, sous réserve d'une signalisation lumineuse spécifique l'autorisant explicitement.", { difficulty: "difficile" }),
  q("divers", "Un conducteur emprunte la bande d'arrêt d'urgence pour doubler une file de véhicules ralentis par un bouchon, en l'absence de toute autorisation de voie dynamique. Que risque-t-il ?", [
    { text: "Une amende et un retrait de points pour circulation sur une voie interdite à la circulation normale, la bande d'arrêt d'urgence étant réservée aux cas d'urgence", correct: true },
    { text: "Aucune sanction tant qu'il ne cause pas d'accident", correct: false },
    { text: "Une simple mise en garde verbale en cas de contrôle, sans amende", correct: false },
    { text: "Une amende uniquement, sans retrait de points, car aucune vitesse excessive n'est en cause", correct: false },
  ], "En dehors des dispositifs de voie dynamique explicitement activés, circuler sur la bande d'arrêt d'urgence pour éviter un ralentissement est une infraction sanctionnée, car cette voie doit rester disponible pour les véhicules en détresse et les secours.", { difficulty: "difficile" }),
  q("divers", "Le stationnement sur un emplacement réservé aux personnes titulaires d'une carte de stationnement pour personnes handicapées, sans en disposer, constitue :", [
    { text: "Un stationnement très gênant sanctionné par une amende de 135 €", correct: true },
    { text: "Un simple stationnement gênant sanctionné par 35 €", correct: false },
    { text: "Une infraction non sanctionnée par une amende mais uniquement par la mise en fourrière", correct: false },
    { text: "Un délit puni d'une peine de prison", correct: false },
  ], "Occuper sans titre un emplacement réservé aux personnes handicapées est qualifié de stationnement très gênant (NATINF spécifique rattaché à l'article R417-11), sanctionné par une amende forfaitaire de 135 €.", { difficulty: "difficile" }),
  q("divers", "Sur autoroute, l'arrêt sur la chaussée (hors bande d'arrêt d'urgence) pour un motif autre qu'une urgence absolue est-il autorisé ?", [
    { text: "Non, il est strictement interdit et particulièrement dangereux, l'arrêt n'étant toléré que sur la bande d'arrêt d'urgence ou aux aires prévues à cet effet", correct: true },
    { text: "Oui, à condition d'allumer ses feux de détresse", correct: false },
    { text: "Oui, pendant une durée maximale de 5 minutes", correct: false },
    { text: "Non, sauf entre 22h et 6h où l'arrêt est toléré", correct: false },
  ], "L'arrêt sur la chaussée d'autoroute est interdit en dehors d'une urgence absolue : seuls la bande d'arrêt d'urgence, les aires de repos ou de service sont prévus pour s'arrêter, l'arrêt sur une voie de circulation exposant à un risque de suraccident majeur.", { difficulty: "difficile" }),
  q("divers", "En cas de défaut d'assurance constaté lors d'un contrôle routier, comment les forces de l'ordre peuvent-elles détecter l'infraction sans même arrêter le conducteur ?", [
    { text: "Par croisement automatique des plaques d'immatriculation avec le Fichier des Véhicules Assurés (FVA) via les radars", correct: true },
    { text: "Uniquement par un contrôle physique manuel des papiers du véhicule", correct: false },
    { text: "Le défaut d'assurance ne peut jamais être détecté sans un contrôle routier direct", correct: false },
    { text: "Uniquement en cas d'accident impliquant le véhicule non assuré", correct: false },
  ], "Les radars automatiques croisent systématiquement les plaques d'immatriculation avec le Fichier des Véhicules Assurés (FVA), permettant de détecter et de sanctionner un défaut d'assurance sans même avoir besoin d'un contrôle routier physique.", { difficulty: "difficile" }),
  q("divers", "Un stationnement gênant devant une entrée d'immeuble ou un garage privé relève-t-il du Code de la route ou uniquement d'un litige de voisinage civil ?", [
    { text: "Du Code de la route : il constitue un stationnement gênant, sanctionné par une amende, en plus d'un éventuel litige civil", correct: true },
    { text: "Uniquement d'un litige civil entre particuliers, sans possibilité de verbalisation par la police", correct: false },
    { text: "Ni l'un ni l'autre, cette situation n'étant pas réglementée en France", correct: false },
    { text: "Uniquement du droit pénal général, sans lien avec le Code de la route", correct: false },
  ], "Stationner devant une entrée d'immeuble ou un garage empêchant l'accès constitue un stationnement gênant au sens du Code de la route, verbalisable par les forces de l'ordre, indépendamment d'un éventuel conflit de voisinage relevant du droit civil.", { difficulty: "difficile" }),
  q("divers", "Un automobiliste stationne son véhicule sur un emplacement de livraison en dehors des horaires de livraison autorisés. Est-ce une infraction ?", [
    { text: "Oui, en dehors des plages horaires autorisées, l'emplacement redevient une zone de stationnement gênant ordinaire, sanctionnable comme telle", correct: true },
    { text: "Non, un emplacement de livraison peut être utilisé librement par tout véhicule en dehors des horaires affichés", correct: false },
    { text: "Non, ces emplacements ne sont jamais verbalisables, quelle que soit l'heure", correct: false },
    { text: "Oui, mais uniquement si un camion de livraison est présent au même moment", correct: false },
  ], "Un emplacement de livraison n'est réservé aux véhicules de livraison que pendant les horaires affichés sur le panonceau ; en dehors de ces plages, y stationner sans y être autorisé constitue un stationnement gênant classique.", { difficulty: "difficile" }),
  q("divers", "Sur autoroute, le dépassement par la droite est-il autorisé lorsque la circulation se fait par files parallèles en cas de fort trafic ?", [
    { text: "Oui, dans cette configuration spécifique de circulation dense en files parallèles, le dépassement par la droite est toléré", correct: true },
    { text: "Non, le dépassement par la droite reste interdit en toute circonstance sur autoroute", correct: false },
    { text: "Oui, mais uniquement pour les véhicules prioritaires", correct: false },
    { text: "Non, sauf si la file de gauche est totalement à l'arrêt", correct: false },
  ], "L'interdiction générale de dépasser par la droite comporte une exception reconnue lorsque la circulation s'effectue par files parallèles en raison d'un trafic dense, situation où chaque file progresse à son propre rythme sans que cela constitue un dépassement irrégulier.", { difficulty: "difficile" }),
  q("divers", "Un véhicule tombé en panne sur autoroute doit être signalé et déplacé. Si le conducteur ne peut pas le déplacer lui-même, que doit-il faire en priorité pour sa sécurité ?", [
    { text: "Évacuer le véhicule par la droite, se mettre à l'abri derrière les glissières de sécurité, et utiliser une borne d'appel d'urgence orange", correct: true },
    { text: "Rester dans le véhicule en panne avec les warnings allumés en attendant une dépanneuse", correct: false },
    { text: "Marcher sur la bande d'arrêt d'urgence en sens inverse de la circulation pour chercher de l'aide", correct: false },
    { text: "Déposer immédiatement un triangle sur la voie de circulation la plus proche du véhicule", correct: false },
  ], "Face à une panne sur autoroute, la priorité absolue est d'évacuer le véhicule et de se mettre à l'abri derrière les glissières de sécurité, puis d'utiliser une borne d'appel d'urgence (positionnées tous les 2 km) plutôt que de rester exposé sur la chaussée ou la bande d'arrêt d'urgence.", { difficulty: "difficile" }),
];
